...
<form action="proses/satuan.php?act=add" method="POST" name="add" id="add" >

  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">

    <tr valign="top">

      <td width="20%" align="right" bgcolor="#FFFFFF">Kode Satuan* : </td>

      <td width="80%" bgcolor="#FFFFFF"><label>

        <input name="kode" type="text" id="kode" size="30" maxlength="100" />
    ...
    <tr valign="top">
      ...
      <td align="right" bgcolor="#FFFFFF">Nama Satuan : </td>
