  ...
  <?php if($id_x == $row_tr['id']) { ?>
      <tr valign="top" bgcolor="#FFFFFF">
        <td width="28%" align="center" ><label>
          <select name="barang" id="barang" style="width:400px;" onChange="cekReturPenjualanAvailable();" disabled="disabled">
            <?php
do {  
mysql_select_db($database_con_gl, $con_gl);
...
?>
        ...
        <td width="9%" align="center" ><label>
          <select name="satuan" id="satuan" onChange="cekReturPenjualanAvailable();" disabled="disabled">
            <?php
do {  
...
?>
        ...
        <td width="15%" align="center" ><label></label>
          <div id="boxRetur">
            <label></label>
            <label>
            <input name="add" type="button" id="add" value="&nbsp;" onclick="ajaxManageReturPenjualan('Simpan',<?php echo $id_x; ?>);" class="checkbutton" title="Simpan Transaksi"/>
