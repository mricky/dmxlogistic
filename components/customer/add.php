...
<form action="proses/customer.php?act=add" method="POST" name="add" id="add" >
  ...
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
    ...
    <tr valign="top">
      ...
      <td bgcolor="#FFFFFF"><input name="contact" type="text" id="contact" size="30" maxlength="100" /></td>
    </tr>
    <tr valign="top">
    ...
    <tr valign="top">
      ...
      <td width="20%" align="right" bgcolor="#FFFFFF">Marketing :</td>

      <td width="80%" bgcolor="#FFFFFF"><label>
        <input name="marketing" type="text" id="marketing" size="30" maxlength="100" />
      </label></td>
    </tr>
