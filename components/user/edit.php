...
<form action="proses/user.php?act=edit" method="POST" name="edit" id="edit">
  ...
  <table width="95%" border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="#FFFFFF" class="datatable">
    ...
    <tr>
      ...
      <td colspan="5"><label>
        ...
        <input name="password" type="hidden" id="password" value="<?php echo $row_edit['password']; ?>"/>

      </label>
        <label>
          <input name="g_pass" type="checkbox" id="g_pass" onclick="if(this.checked) { document.getElementById('password').type='password'; document.getElementById('password').value=''; document.getElementById('password').size='20'; document.getElementById('password').maxLength='100'; }else{ document.getElementById('password').type='hidden'; document.getElementById('password').value='<?php echo $row_edit['password']; ?>';}" value="1"/>
      <small>Cek box untuk ganti password</small>
    ...
    <tr valign="top">
      ...
      <td colspan="5"><table width="100%" border="0" cellspacing="1" cellpadding="2" class="datatable">
        ...
        <tr>
          ...
          <th width="20%">Klasifikasi Akun </th>
        ...
        <tr valign="top">
          ...
          <td><ul style="list-style:none;">
            ...
            <li>
                <label>
                <input name="akun_4" type="checkbox" id="akun_4" value="DD-1" <?php if(strstr($row_edit['akses'],"DD-1")) { ?>checked="checked"<?php } ?>/>
                  Lihat Data</label>
              </li>
            <li>
                <label>
...
Lihat Data</li>
    ...
    <tr valign="top">
      ...
      <td colspan="5"><table width="100%" border="0" cellspacing="1" cellpadding="2" class="datatable">
        ...
        <tr>
          ...
          <th width="19%" valign="top">Transaksi Order Retail</th>

          <th width="20%">Extend STNK</th>
          <th width="20%" valign="top">Extend Polis</th>
        ...
        <tr valign="top">
          ...
          <td><ul style="list-style:none;">
              <li>
                <label>
                <input name="extendstnk_1" type="checkbox" id="extendstnk_1" value="EX-1-1" <?php if(strstr($row_edit['akses'],"EX-1-1")) { ?>checked="checked"<?php } ?>/>
                  Tambah Data</label>
              </li>
            <li>
                <label>
                <input name="extendstnk_2" type="checkbox" id="extendstnk_2" value="EX-1-2" <?php if(strstr($row_edit['akses'],"EX-1-2")) { ?>checked="checked"<?php } ?>/>
                  Edit Data</label>
              </li>
            <li>
                <label>
                <input name="extendstnk_3" type="checkbox" id="extendstnk_3" value="EX-1-3" <?php if(strstr($row_edit['akses'],"EX-1-3")) { ?>checked="checked"<?php } ?>/>
                  Hapus Data</label>
              </li>
            <li>
                <label>
                <input name="extendstnk_4" type="checkbox" id="extendstnk_4" value="EX-1" <?php if(strstr($row_edit['akses'],"EX-1")) { ?>checked="checked"<?php } ?>/>
                  Lihat Data</label>
              </li>
          </ul></td>
          <td><ul style="list-style:none;">
    ...
    <tr valign="top">
      <td align="right">&nbsp;</td>
      <th width="17%">Transaksi Mutasi</th>
      <th width="16%">Transaksi Replace</th>
      <th width="17%">Transaksi Order Corporate </th>
      <th width="16%">Invoice Kontrak </th>
      <th width="17%">TransaksiCheckOutIN</th>
    </tr>
    <tr valign="top">
      <td align="right">&nbsp;</td>
      <td><ul style="list-style:none;">
      ...
      <td><ul style="list-style:none;">
          <li>
            <label>
            <input name="checkoutin_1" type="checkbox" id="checkoutin_1" value="OI-1-1" <?php if(strstr($row_edit['akses'],"OI-1-1")) { ?>checked="checked"<?php } ?>/>
              Tambah Data</label>
          </li>
        <li>
            <label>
            <input name="checkoutin_2" type="checkbox" id="checkoutin_2" value="OI-1-2" <?php if(strstr($row_edit['akses'],"OI-1-2")) { ?>checked="checked"<?php } ?>/>
              Edit Data</label>
          </li>
        <li>
            <label>
            <input name="checkoutin_3" type="checkbox" id="checkoutin_3" value="OI-1-3" <?php if(strstr($row_edit['akses'],"OI-1-3")) { ?>checked="checked"<?php } ?>/>
              Hapus Data</label>
          </li>
        <li>
            <label>
            <input name="checkoutin_4" type="checkbox" id="checkoutin_4" value="OI-1" <?php if(strstr($row_edit['akses'],"OI-1")) { ?>checked="checked"<?php } ?>/>
              Lihat Data</label>
          </li>
      </ul></td>
    </tr>
    <tr valign="top">
      <td align="right">&nbsp;</td>
      <th width="17%">Transaksi Kecelakaan</th>
      <th width="16%">Transaksi Kasir</th>
      <th>Transaksi DO </th>
      <th>&nbsp;</th>
      <th>&nbsp;</th>
    </tr>
    <tr valign="top">
      ...
      <td><ul style="list-style:none;">
          <li>
            <label>
            <input name="accident_1" type="checkbox" id="accident_1" value="AC-1-1" <?php if(strstr($row_edit['akses'],"AC-1-1")) { ?>checked="checked"<?php } ?>/>
              Tambah Data</label>
          </li>
        <li>
            <label>
            <input name="accident_2" type="checkbox" id="accident_2" value="AC-1-2" <?php if(strstr($row_edit['akses'],"AC-1-2")) { ?>checked="checked"<?php } ?>/>
              Edit Data</label>
          </li>
        <li>
            <label>
            <input name="accident_3" type="checkbox" id="accident_3" value="AC-1-3" <?php if(strstr($row_edit['akses'],"AC-1-3")) { ?>checked="checked"<?php } ?>/>
              Hapus Data</label>
          </li>
        <li>
            <label>
            <input name="mutasi_4" type="checkbox" id="mutasi_4" value="AC-1" <?php if(strstr($row_edit['akses'],"AC-1")) { ?>checked="checked"<?php } ?>/>
              Lihat Data</label>
          </li>
      </ul></td>
      <td><ul style="list-style:none;">
          <li>
            <label>
            <input name="kasir_1" type="checkbox" id="kasir_1" value="KS-1-1" <?php if(strstr($row_edit['akses'],"KS-1-1")) { ?>checked="checked"<?php } ?>/>
              Tambah Data</label>
          </li>
        <li>
            <label>
            <input name="kasir_2" type="checkbox" id="kasir_2" value="KS-1-2" <?php if(strstr($row_edit['akses'],"KS-1-2")) { ?>checked="checked"<?php } ?>/>
              Edit Data</label>
          </li>
        <li>
            <label>
            <input name="kasir_3" type="checkbox" id="kasir_3" value="KS-1-3" <?php if(strstr($row_edit['akses'],"KS-1-3")) { ?>checked="checked"<?php } ?>/>
              Hapus Data</label>
          </li>
        <li>
            <label>
            <input name="kasir_4" type="checkbox" id="kasir_4" value="KS-1" <?php if(strstr($row_edit['akses'],"KS-1")) { ?>checked="checked"<?php } ?>/>
              Lihat Data</label>
          </li>
      </ul></td>
      <td><ul style="list-style:none;">
          <li>
            <label>
            <input name="do_1" type="checkbox" id="do_1" value="DO-1-1" <?php if(strstr($row_edit['akses'],"DO-1-1")) { ?>checked="checked"<?php } ?>/>
              Tambah Data</label>
          </li>
        <li>
            <label>
            <input name="do_2" type="checkbox" id="do_2" value="DO-1-2" <?php if(strstr($row_edit['akses'],"DO-1-2")) { ?>checked="checked"<?php } ?>/>
              Edit Data</label>
          </li>
        <li>
            <label>
            <input name="do_3" type="checkbox" id="do_3" value="DO-1-3" <?php if(strstr($row_edit['akses'],"DO-1-3")) { ?>checked="checked"<?php } ?>/>
              Hapus Data</label>
          </li>
        <li>
            <label>
            <input name="do_4" type="checkbox" id="do_4" value="DO-1" <?php if(strstr($row_edit['akses'],"DO-1")) { ?>checked="checked"<?php } ?>/>
              Lihat Data</label>
          </li>
      </ul></td>
      <td>&nbsp;</td>
    ...
    <tr valign="top">
      ...
      <td colspan="5"><table width="100%" border="0" cellspacing="1" cellpadding="2" class="datatable">
          <tr>
            <th width="21%">Karyawan</th>
            <th width="19%">Unit Kerja</th>
            <th width="19%">Customer Corporate</th>
            <th width="21%">Customer Retail</th>
...
Edit Data</label>
            ...
            <td><ul style="list-style:none;">
              ...
              <li>
                  <label>
                  <input name="cretail_2" type="checkbox" id="cretail_2" value="DD-7-2" <?php if(strstr($row_edit['akses'],"DD-7-2")) { ?>checked="checked"<?php } ?>/>
                    Edit Data</label>
                </li>
              <li>
                  <label>
                  <input name="cretail_3" type="checkbox" id="cretail_3" value="DD-7-3" <?php if(strstr($row_edit['akses'],"DD-7-3")) { ?>checked="checked"<?php } ?>/>
                    Hapus Data</label>
                </li>
              <li>
                  <label>
                  <input name="cretail_4" type="checkbox" id="cretail_4" value="DD-7" <?php if(strstr($row_edit['akses'],"DD-7")) { ?>checked="checked"<?php } ?>/>
                    Lihat Data</label>
                </li>
            </ul></td>
            <td><ul style="list-style:none;">
    ...
    <tr valign="top">
      ...
      <td colspan="5"><table width="100%" border="0" cellspacing="1" cellpadding="2" class="datatable">
          <tr>
            ...
            <th width="19%">Jenis Kendaraan</th>
            <th width="19%">Tipe Kendaraan</th>
            <th width="21%">Master Kendaraan</th>
          ...
          <tr>
            <td><ul style="list-style:none;">
              ...
              <li>
                  <label><input name="phservice_4" type="checkbox" id="phservice_4" value="JS-4" <?php if(strstr($row_edit['akses'],"JS-4")) { ?>checked="checked"<?php } ?>/>
    ...
    <tr valign="top">
      ...
      <td colspan="5"><table width="100%" border="0" cellspacing="1" cellpadding="2" class="datatable">
        ...
        <tr>
          ...
          <th width="19%">Kas Masuk</th>

          <th width="19%">Kas Keluar</th>
    ...
    <tr valign="top">
      ...
      <td colspan="5"><table width="100%" border="0" cellspacing="1" cellpadding="2" class="datatable">
        ...
        <tr>
          ...
          <th width="19%">Barang</th>

          <th width="19%">Kelompok Barang</th>

          <th width="21%">Satuan</th>
          <th width="20%">&nbsp;</th>
        </tr>
    ...
    <tr valign="top">
      ...
      <td colspan="5"><table width="100%" border="0" cellspacing="1" cellpadding="2" class="datatable">
        ...
        <tr>
          ...
          <th width="19%">Retur</th>

          <th width="19%">Pembayaran Hutang</th>
...
Neraca</li>
    ...
    <tr>
      ...
      <td colspan="5"><label><input name="Save" type="submit" id="Save" value="Simpan" /></label> <label><input type="button" name="Button" value="Batal" onClick="javascript:history.go(-1);"></label></td>
    </tr>
  </table>
