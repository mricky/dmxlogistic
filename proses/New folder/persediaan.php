...
$act = $_GET[act];
$url = "index.php?component=persediaan";
...
if (isset($error)) {
	...
	if($act =='add') {
	$query = "INSERT INTO gl_rtrans (no_ref, tgl, keterangan, jenis, gudang) VALUES ('$_POST[noreferensi]', '$_POST[tanggal]', '$_POST[keterangan]', '$_POST[jenis]', '$_POST[gudang]')";
	$query_add = "INSERT INTO gl_trans (id, no_ref, transaksi, total, pos, akun) VALUES (NULL, '$_POST[noreferensi]', '$_POST[keterangan]', '$_POST[total_2]', 'D', '$_POST[akun]')";
  	mysql_query($query_add, $con_gl);
	}else if($act=='edit'){
	$query ="UPDATE gl_rtrans SET tgl='$_POST[tanggal]', keterangan='$_POST[keterangan]', jenis='$_POST[jenis]', gudang='$_POST[gudang]' WHERE no_ref='$_POST[noreferensi]'";
