...
www.bimextour.com</td>
    ...
    <td width="39%" align="left" valign="top"><strong>DATE : </strong><?php echo date("l F j, Y, g:i a"); ?> <strong>NOMOR :</strong><?php echo $_GET['referensi'];?></td>
  ...
  <tr>
    ...
    <td colspan="3" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4">
      ...
      <tr>
        ...
        <td width="55%" valign="top"><?php echo $row_ticketing['customer'];?></td>

        <td width="9%" valign="top">Email</td>

        <td width="1%" valign="top">:</td>

        <td width="28%" valign="top"><?php echo $row_ticketing['emailalt'];?></td>
  ...
  <tr>
    ...
    <td colspan="3" align="left" valign="top"><table width="100%" border="1" cellspacing="0" cellpadding="4">
      ...
      <tr valign="top">
        ...
        <td width="24%"><?php echo $row_detail['nama_penumpang'];?></td>

        <td width="16%"><?php echo $row_detail['airline'];?></td>

        <td width="11%"align ="center"><?php echo $row_detail['tglrealisasi'];?></td>

        <td width="31%"><?php echo $row_detail['from'];?> - <?php echo $row_detail['to'];?></td>

        <td width="16%" align="right"><span style="background:#EEE;font-weight:bold;text-decoration:underline;">

          <?php  echo number_format($row_detail['nominaljual_airline'],0,',','.');?>
  ...
  <tr>
    ...
    <td colspan="3" align="right" valign="top"><table align="left" width="1209" height="113" border="1">
      ...
      <tr>
        ...
        <td height="8" colspan="2" align="left"><strong>Says : </strong><i><?php echo ucwords(Terbilang($row_ticketing['nominaljual_airline']));?> Rupiah</i></td>

        <td height="8" colspan="2" align="right"><strong>Total : <span style="background:#EEE;font-weight:bold;text-decoration:underline;">

          <?php  echo number_format($row_ticketing['nominaljual_airline'],0,',','.');?>
