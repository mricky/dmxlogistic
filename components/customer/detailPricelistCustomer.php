...
<tr>
	<th width="55%" align="center">Service</th>
		...
		<th width="55%" align="center">Estimasi</th>
	...
	if(isset($_SESSION['idcustomer'])){
		...
		foreach($_SESSION['idcustomer'] as $idk){
			...
			<?php
					...
					echo "<a style='cursor:pointer;' onclick=\"javascript: kirimRequest('components/customer/detailPricelistCustomer.php', 'ajax=true&act=hapus&pos=$i&idpricelist='+$idpricelist, 'ajaxDiv', 'div');\" title='Hapus data'><img src='images/delete.png' /></a>";
					echo "</td>";
				echo "</tr>";
  ...
  <td align="right"  bgcolor="#00CC99" style="background:none;border:none;">
    ...
    <input type="text" name="service" id="service" size="10" placeholder="Layanan" readonly="readonly" style="background-color:#fff;border:1px solid #999; height:16px; " onClick="NewWindow('index.php?component=service&amp;task=list&amp;open=window','name','825','450','yes');return false" /></td>
              ...
              <td align="right" bgcolor="#00CC99" style="background:none;border:none;"><input type="hidden" name="idhandling" id="idhandling" size="2" />
                <input type="text" name="handling" id="handling" size="10" placeholder="Armada" readonly="readonly" style="background-color:#fff;border:1px solid #999; height:16px; " onClick="NewWindow('index.php?component=handling&amp;task=list&amp;open=window','name','825','450','yes');return false" /></td>
