...
<form action="proses/agent.php?act=add" method="POST" name="add" id="add" >
  ...
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
    ...
    <tr valign="top">
      ...
      <td bgcolor="#FFFFFF"><input name="npwp" type="text" id="npwp" size="30" maxlength="100" /></td>
    </tr>
    <tr valign="top">
      <td align="right" bgcolor="#FFFFFF">BANK :</td>
      <td bgcolor="#FFFFFF"><input name="bank" type="text" id="bank" size="30" maxlength="100" /></td>
    </tr>
    <tr valign="top">
      <td align="right" bgcolor="#FFFFFF">REKENING BANK:</td>
      <td bgcolor="#FFFFFF"><input name="rekening" type="text" id="rekening" size="30" maxlength="100" /></td>
    </tr>
    <tr valign="top">
      <td align="right" bgcolor="#FFFFFF">ATAS NAMA :</td>
      <td bgcolor="#FFFFFF"><input name="atas_nama" type="text" id="atas_nama" size="30" maxlength="100" /></td>
    </tr>
