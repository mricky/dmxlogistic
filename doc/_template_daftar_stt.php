...
<P align="center" class="style2"><strong>DAFTAR SURAT TANDA TERIMA BARANG</strong></P>
...
<table width="100%" border="1" cellpadding="4" cellspacing="0" bordercolor="#000000">
    <tr bgcolor="#CCCCCC">
      <th width="5">No.</th>
      <th width="30">Tgl. Connote</th>
      <th width="106">Tgl. Manifest</th>
  ...
  <?php 	
    ...
    <?php $i = 1;do { ?>
        ...
        <tr valign="top">
          ...
          <td align="left"><?php echo $row_data['MARKETING']; ?></td>
          <td align="left"><?php $t_marketing += $row_data['COST_FEEMARKETING'];echo number_format($row_data['COST_FEEMARKETING'],0,',','.').",-"; ?></td>
          <td align="left"><?php $t_refund += $row_data['COST_FEEMARKETING'];echo number_format($row_data['COST_FEEMARKETING'],0,',','.').",-"; ?></td>
          ...
          <td align="left"><?php $t_cost += $row_data['TOTALCOST'];echo number_format($row_data['TOTALCOST'],0,',','.').",-"; ?></td>
          <td align="left"><?php $t_profit += $row_data['TOTALPROFIT'];echo number_format($row_data['TOTALPROFIT'],0,',','.').",-"; ?></td>
        </tr>
        <?php 
		$nomor ++;
			$i++;
    ...
    <tr valign="top">
        ...
        <td align="left">&nbsp;</td>
        <td align="left">&nbsp;</td>
        <td align="left"><strong><?php echo number_format($t_marketing,0,',','.').",-";?></strong></td>
        <td align="left"><strong><?php echo number_format($t_refund,0,',','.').",-";?></strong></td>
        <td align="left">&nbsp;</td>
        <td align="left">&nbsp;</td>
        <td align="left"><strong><?php echo number_format($t_colly,0,',','.').",-";?></strong></td>
        <td align="left"><strong><?php echo number_format($t_weight,0,',','.').",-";?></strong></td>
        ...
        <td align="left"><strong><?php echo number_format($t_cost,0,',','.').",-";?></strong></td>
        <td align="left"><strong><?php echo number_format($t_profit,0,',','.').",-";?></strong></td>
    </tr> 
</table>
