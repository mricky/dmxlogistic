...
$query_data = "SELECT * from gl_unitkerja";
if($_GET[cr_txt]<>'' AND $_GET[cr_txt]<>'+') { 
$decode_cr = str_replace("+"," ",$_GET[cr_txt]);
$query_data .=" where id LIKE '%%$decode_cr%%' OR unitkerja LIKE '%%$decode_cr%%' OR keterangan LIKE '%%$decode_cr%%'";
}
$query_data .=" order by unitkerja asc";
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable"> 
  <tr valign="top" bgcolor="#FFFFFF" class="hide">
        <td><?php if(strstr($_SESSION['akses'],"UK-1-1")) { ?><a href="index.php?component=unitkerja&amp;task=add"><img src="images/add_new.png" border="0" /></a><?php } ?></td>
        <td colspan="3" align="right" style="border-bottom:solid 1px #E2EAC1;border-right:solid 1px #E2EAC1;"><form id="search" name="search" method="post" action="">
          <label>
      <input name="cr_txt" type="text" id="cr_txt" placeholder="Find by: unit kerja, keterangan"; onclick="this.value='';"<?php echo $_REQUEST['cr_txt'];?>" size="30" maxlength="100" />
      </label>
      <label>
	...
	if(isset($_POST['Search'])) {
		echo "<script>window.location=\"index.php?component=unitkerja&cr_txt=".str_replace(" ","+",$_POST[cr_txt])."\";</script>";
	}
	?></td>
  </tr>
  <tr>
    <th width="220"><strong>Unit Kerja</strong></th>
    <th width="1">&nbsp;</th>
    <th width="699"><strong>Keterangan</strong></th>
  ...
  <?php do { ?>
    <tr valign="top" bgcolor="#FFFFFF">
      ...
      <td align="center" class="hide"><?php if(strstr($_SESSION['akses'],"UK-1-2")) { ?><a href="index.php?component=unitkerja&amp;task=edit&amp;id=<?php echo $row_data['id']; ?>"><img src="images/edit_.png" border="0" /></a><?php } ?> <?php if(strstr($_SESSION['akses'],"UK-1-3")) { ?><!--<a href="index.php?component=unitkerja&amp;task=delete&amp;id=<?php echo $row_data['id']; ?>" class="ask"><img src="images/delete_.png" border="0" /></a>--><?php } ?></td>
    </tr>
  ...
  <?php } ?>
  <tr class="hide">
    <td colspan="4"><?php if(strstr($_SESSION['akses'],"UK-1-1")) { ?><a href="index.php?component=unitkerja&amp;task=add"><img src="images/add_new.png" border="0" /></a><?php } ?></td>
  </tr>
</table>