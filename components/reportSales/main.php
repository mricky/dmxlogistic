...
include('include/widget_export_daftar_sales.php');
...
?>
  ...
  <input name="Search" type="submit" id="Search" value="Search" />
	...
	if(isset($_POST['Search'])) {
			...
			echo "<script>window.location=\"index.php?component=reportSales&mulai=".$_POST[mulai]."&status=".$_POST[status]."&sampai=".$_POST[sampai]."&cr_txt=".str_replace(" ","+",$_POST[cr_txt])."\";</script>";
  ...
  <?php do { ?>
      ...
      <tr valign="top" bgcolor="#FFFFFF">
        ...
        <td><a href="include/fakturpajak.php?id=<?php echo $row_data['IDSTT'];?>&invoice_no=<?php echo $row_data['IDSTT'];?>" onclick="NewWindow(this.href,'name','935','500','yes');return false" title="Faktur Pajak"><img src="images/invoices.png" border="0" /></a></td>
      </tr>
