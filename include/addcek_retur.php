...
mysql_select_db($database_con_gl, $con_gl);
$query_cek_hut = "SELECT gl_trans.no_ref, gl_trans.total FROM gl_trans WHERE gl_trans.no_ref='$row_cek_r[no_ref]' AND gl_trans.transaksi LIKE '%Hutang%'";
...
<label><input name="add" type="button" id="add" value="&nbsp;" onclick="ajaxManageReturPembelian('Tambah');" class="checkbutton" title="Tambah Transaksi"/></label><input name="xx_ref" type="hidden" id="xx_ref" value="<?php echo $row_cek_hut['no_ref']; ?>" />
<?php }else{ ?>
