...
$url = base_url("index.php?component=cut");
...
if (isset($error)) {
	...
	if($act =='add') {
            ...
            $query = "INSERT INTO ref_dm_cut (cut_name,cut_alias)"
                    . " VALUES ('$_POST[name]','$_POST[alias]');";
            //'$_POST[]'
           //print_r($query);
        }else if($act=='edit'){
            $query = "UPDATE ref_dm_cut SET cut_name='$_POST[name]',cut_alias='$_POST[alias]' WHERE cut_code='$_POST[id]'";
		//print_r($query);
		//break;
