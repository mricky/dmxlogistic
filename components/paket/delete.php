...
$query_edit = sprintf("SELECT * FROM jenis_paket WHERE jenis_paket_id = %s", $colname_edit);
...
<h1>Hapus Data Paket</h1>

<form action="proses/paket.php?act=delete" method="POST" name="delete" id="delete" >
  ...
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
    ...
    <tr valign="top">
      ...
      <input name="nama" type="text" id="nama" value="<?php echo $row_edit['jenis_paket_name']; ?>" size="30" maxlength="100" />
      <input name="id" type="hidden" id="id" value="<?php echo $row_edit['jenis_paket_id']; ?>" />
      </label></td>
    </tr>
