...
$query_data = "SELECT * from gl_katagoriarsip";

if($_GET[cr_txt]<>'' AND $_GET[cr_txt]<>'+') { 

$decode_cr = str_replace("+"," ",$_GET[cr_txt]);

$query_data .=" where id LIKE '%%$decode_cr%%' OR katagori LIKE '%%$decode_cr%%' OR keterangan LIKE '%%$decode_cr%%'";

}

$query_data .=" order by katagori asc";
...
<h1>Katagori Arsip</h1>

<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable"> 

  <tr valign="top" bgcolor="#FFFFFF" class="hide">

        <td><?php if(strstr($_SESSION['akses'],"PD-5-1")) { ?><a href="index.php?component=katagoriarsip&amp;task=add"><img src="images/add_new.png" border="0" /></a><?php } ?></td>
	...
	if(isset($_POST['Search'])) {
		...
		echo "<script>window.location=\"index.php?component=katagoriarsip&cr_txt=".str_replace(" ","+",$_POST[cr_txt])."\";</script>";
  ...
  <tr>
    ...
    <th width="221"><strong>Katagori Arsip </strong></th>

    <th width="583"><strong>Keterangan</strong></th>

    <th width="189">&nbsp;</th>
    <th width="267" align="center" class="hide"><strong>Aksi</strong></th>
  </tr>
  ...
  <?php do { ?>
    ...
    <tr valign="top" bgcolor="#FFFFFF">
      ...
      <td><?php echo $row_data['katagori']; ?></td>

      <td><?php echo $row_data['keterangan']; ?></td>

      <td>&nbsp;</td>
      <td align="center" class="hide"><?php if(strstr($_SESSION['akses'],"PD-5-2")) { ?><a href="index.php?component=katagoriarsip&amp;task=edit&amp;id=<?php echo $row_data['id']; ?>"><img src="images/edit_.png" border="0" /></a><?php } ?> <?php if(strstr($_SESSION['akses'],"PD-5-3")) { ?><a href="index.php?component=katagoriarsip&amp;task=delete&amp;id=<?php echo $row_data['id']; ?>" class="ask"><img src="images/delete_.png" border="0" /></a><?php } ?></td>
    </tr>
  ...
  <tr class="hide">
    ...
    <td colspan="4"><a href="index.php?component=katagoriarsip&amp;task=add"><img src="images/add_new.png" border="0" /></a></td>
  </tr>
</table>
