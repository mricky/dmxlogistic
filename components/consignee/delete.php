...
$query_edit = sprintf("SELECT * FROM penerima WHERE IDPENERIMA = %s", $colname_edit);
...
<h1>Hapus Penerima </h1>

<form action="proses/consignee.php?act=delete" method="POST" name="delete" id="delete" >
  ...
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
    ...
    <tr valign="top">
      ...
      <input name="nama" type="text" id="nama" size="30" maxlength="100"  value="<?php echo $row_edit['NAMAPENERIMA']; ?>"/>
      </label></td>
    ...
    <tr valign="top">
      ...
      <input name="email" type="email" id="email" size="30" maxlength="100" value="<?php echo $row_edit['EMAIL']; ?>"/>
      <input name="id" type="hidden" id="id" value="<?php echo $row_edit['IDPENERIMA']; ?>" /></td>
