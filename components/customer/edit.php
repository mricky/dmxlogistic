...
<form action="proses/customer.php?act=edit" method="POST" name="edit" id="edit" >

<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">

    <tr valign="top">
      <td width="20%" align="right" bgcolor="#FFFFFF">Nama * :</td>
      <td width="80%" bgcolor="#FFFFFF"><input name="nama" type="text" id="nama" size="30" maxlength="100"  value="<?php echo $row_edit['NAMACUSTOMER']; ?>"/></td>
    </tr>
    <tr valign="top">
    ...
    <tr valign="top">
      <td align="right" bgcolor="#FFFFFF">Contact Person</td>
      <td bgcolor="#FFFFFF"><input name="contact" type="text" id="contact" size="30" maxlength="100" value="<?php echo $row_edit['CONTACTPERSON']; ?>"/></td>
    </tr>
    <tr valign="top">
    ...
    <tr valign="top">
      ...
      <input name="id" type="hidden" id="id" value="<?php echo $row_edit['IDCUSTOMER']; ?>" /></td>
    </tr>
    <tr valign="top">

      <td align="right" bgcolor="#FFFFFF">Marketing :</td>

      <td bgcolor="#FFFFFF"><input name="marketing" type="text" id="marketing" size="30" maxlength="100" value="<?php echo $row_edit['MARKETING']; ?>"/></td>
    </tr>
