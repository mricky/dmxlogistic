...
$act = $_GET[act];
$url = "index.php?component=returpenjualan";
...
if (isset($error)) {
	...
	$query_add = "INSERT INTO gl_trans (id, no_ref, transaksi, total, pos, akun) VALUES (NULL, '$_POST[noreferensi]', '$_POST[keterangan]', '$_POST[totalretur]', 'K', '$_POST[akunhutang]')";
