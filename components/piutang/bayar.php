...
$query = "SELECT * from v_invoice_stt where IDSTT = '$_GET[noreferensi]'";
$order = mysql_query($query, $con_gl) or die(mysql_error());
$row_order = mysql_fetch_assoc($order);
$totalRows_order = mysql_num_rows($order);

$query_listbayar = "SELECT * from v_pembayaran_stt where IDSTT = '$_GET[noreferensi]'";
...
<div id="divDetail">
  <table width="100%" border="0" cellspacing="0" cellpadding="4" class="datatable" id="cusinfo">
    ...
    <tr>
      <td align="right" valign="top" style="background:#FFF;">STT Status :</td>
      <td valign="top" style="background:#FFF;">Collect / Cash</td>
...
<form action="proses/penerimaanuangstt.php?act=bayar&IDSTT=<?php echo $row_order['IDSTT']?>" method="POST" name="bayar" id="bayar" >
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable">
    <tr>
...
?>
      ...
      <td valign="top" bgcolor="#FFFFFF">Total Tagihan   Rp :
        <label></label>
        <input name="totalsewa" type="text" id="totalsewa"  value="<?php echo $row_order['TOTAL_CHARGE']; ?>" size="20" maxlength="10" style="text-align:right;" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td valign="top" bgcolor="#FFFFFF">Kekurangan Rp :
        <?php
		  $kekurangan = ($row_order['SISA'] == "" ? $row_order['TOTAL_CHARGE'] : $row_order['SISA']);
		  ?>
