...
$query_getbrg = "SELECT gl_trans.transaksi FROM gl_trans WHERE gl_trans.no_ref='$_GET[referensi]' AND gl_trans.barang<>'' ORDER BY gl_trans.id desc";
...
$query_getotal = "SELECT gl_trans.total, gl_trans.diskon, gl_trans.jumlah, gl_trans.hargasatuan FROM gl_trans WHERE gl_trans.no_ref='$_GET[referensi]' AND gl_trans.barang <>'' ORDER BY gl_trans.id desc";
...
$query_getbrg2 = "SELECT gl_trans.transaksi FROM gl_trans WHERE gl_trans.no_ref='$_GET[referensi]' AND gl_trans.barang<>'' ORDER BY gl_trans.id desc";
...
$query_getotal2 = "SELECT gl_trans.total, gl_trans.diskon, gl_trans.jumlah, gl_trans.hargasatuan FROM gl_trans WHERE gl_trans.no_ref='$_GET[referensi]' AND gl_trans.barang <>'' ORDER BY gl_trans.id desc";
  ...
  <tr valign="top" style="height:325px;">
    ...
    <td style="border:solid 1px #000000;border-top:none;border-left:none;"><ul style="list-style:none;margin:0;padding:0;">
      ...
      <?php do { ?>
        ...
        <li style="padding-left:15px;"><?php echo $row_getbrg['transaksi']; ?></li>

        <?php } while ($row_getbrg = mysql_fetch_assoc($getbrg)); ?></ul></td>
    ...
    <td align="right" style="border:solid 1px #000000;border-top:none;border-left:none;"><ul style="list-style:none;margin:0;padding:0;">
      ...
      <?php $subtotal = 0; $diskon=0; do { ?>
        ...
        <li><?php $subtotal +=$row_getotal['jumlah']*$row_getotal['hargasatuan']; echo number_format($subtotal,0,',','.').",-";if($row_getotal[diskon]<>'') { $diskon += intval($row_getotal[diskon]*$subtotal/100);}?></li>

        <?php } while ($row_getotal = mysql_fetch_assoc($getotal));?></ul></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr valign="top" style="height:325px;">
    ...
    <td style="border:solid 1px #000000;border-top:none;border-left:none;"><ul style="list-style:none;margin:0;padding:0;">
      ...
      <li style="padding-left:15px;"><?php echo $row_getbrg2['transaksi']; ?></li>
