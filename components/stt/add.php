...
<div id="divDetail">
  <table width="100%" border="0" cellspacing="0" cellpadding="4" class="datatable" id="cusinfo">
    ...
    <tr>
      ...
      <a href="index.php?component=stt&amp;task=addCustomer&amp;open=window" onclick="NewWindow(this.href,'name','1025','450','yes');return false"><img src="images/add_.png" alt="" hspace="2" border="0" style="position:absolute;" /></a>
      <?php } ?>
      </label></td>
      ...
      <td valign="top" style="background:#FFF;"><input type="text" name="penerima" id="penerima" placeholder="Cari Penerima ..." size="28" readonly="readonly" style="background-color:#fff;border:1px solid #999; height:16px;" onclick="NewWindow('index.php?component=stt&amp;task=listPenerima&amp;open=window','name','925','450','yes');return false" />
        ...
        <label id="divKontak">
        <?php if(strstr($_SESSION['akses'],"DD-2-1")) { ?>
        <a href="index.php?component=stt&amp;task=addPenerima&amp;open=window" onclick="NewWindow(this.href,'name','1025','450','yes');return false"><img src="images/add_.png" alt="" hspace="2" border="0" style="position:absolute;" /></a>
        <?php } ?>
      </label></td>
    </tr>
    <tr>
...
<form action="proses/stt.php?act=add" method="post" name="add" id="add" >
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable">
    <tr>
      ...
      <th colspan="2">Informasi Kota Pengiriman</th>
    </tr>
    <tr>
      <td width="9%" align="right" valign="top" bgcolor="#FFFFFF">No STT *: </td>
      ...
      <td align="left" valign="top">Kota Asal * :</td>
      <td valign="top"><input type="hidden" name="idorigin" id="idorigin" />
    ...
    <tr valign="top">
      <td align="right" valign="top" bgcolor="#FFFFFF">Resi Vendor :</td>
      <td colspan="4" valign="top" bgcolor="#FFFFFF"><input name="airwaybill" type="text" id="airwaybill" size="30" maxlength="100" /></td>
    ...
    <tr valign="top">
      ...
      <td valign="top" bgcolor="#FFFFFF">&nbsp;</td>
      <td width="13%" align="left">Kota Tujuan* : </td>
      <td width="31%" bgcolor="#FFFFFF"><input type="hidden" name="iddestination" id="iddestination" />
    ...
    <tr valign="top">
      ...
      <td width="5%" valign="top" bgcolor="#FFFFFF"><input type="checkbox" name="isdimensi" readonly="readonly" id='isdimensi' onclick="calcDimesi();" /></td>
      <td width="11%" valign="top" bgcolor="#FFFFFF">P :
      <input name="panjang" type="text" id="panjang" value="0" size="5" maxlength="5";" style="text-align:right;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" onchange="calcDimesi();"/></td>
      <td width="10%" valign="top" bgcolor="#FFFFFF">L :
      <input name="lebar" type="text" id="lebar" value="0" size="5" maxlength="5";" style="text-align:right;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" onchange="calcDimesi();"/></td>
      <td width="18%" valign="top" bgcolor="#FFFFFF">T:
      <input name="tinggi" type="text" id="tinggi" value="0" size="5" maxlength="5";" style="text-align:right;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" onchange="calcDimesi();"/></td>
      <td valign="top" bgcolor="#FFFFFF">&nbsp;</td>
...
/ colly</td>
    ...
    <tr valign="top">
      ...
      <td colspan="4" valign="top" bgcolor="#FFFFFF"><input name="nosmu" type="text" id="nosmu" size="25" maxlength="20";" style="text-align:right;" /></td>
      <td valign="top" bgcolor="#FFFFFF">&nbsp;</td>
      <td align="right">&nbsp;</td>
      <td bgcolor="#FFFFFF">&nbsp;</td>
    </tr>
...
if(err!='') alert(err);
if(document.getElementById('weight').value==0) err+='Berat harus lebih dari 0\n'; 
if(err!='') alert(err);
else {                 NewWindow('index.php?component=stt&amp;task=listPricelist&amp;customer='+document.getElementById('idcustomer').value+'&amp;weight='+document.getElementById('weight').value+'&amp;open=window','name','925','450','yes');return false }"/>
      </span></td>
      <td align="left" bgcolor="#FFFFFF">Rate Kirim 
        <input name="rate" type="text" id="rate" value="0" size="10" maxlength="20";" style="text-align:right;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" onchange="hitungCharge();"/>
/ KG</td>
      <td valign="top" bgcolor="#FFFFFF">&nbsp;</td>
      <td align="right">&nbsp;</td>
      <td bgcolor="#FFFFFF">&nbsp;</td>
    ...
    <tr>
	  ...
	  -->
      <!-- Added by suwondo -->
      <input name="charge" type="text" id="charge" onchange="grandTotal();" value="0" readonly="readonly" size="20" maxlength="10" style="border:1px solid #ff0000;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" /></td>
      <td valign="top">&nbsp;</td>
      <td align="right">&nbsp;</td>
      <td valign="top">&nbsp;</td>
    </tr>
    ...
    <tr>
      ...
      <td colspan="4" valign="top" bgcolor="#FFFFFF"><select id="insurance" name="insurance" onchange="calcInsurance();" >
        ...
        <input name="chargeinsurace" type="text" id="chargeinsurace"  readonly="readonly" value="0" size="10" maxlength="10" style="text-align:right;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" /></td>
      <td bgcolor="#FFFFFF">&nbsp;</td>
      <td align="right" valign="top">&nbsp;</td>
      <td valign="top">&nbsp;</td>
    </tr>
    <tr>
      ...
      <td colspan="4" valign="top" bgcolor="#FFFFFF"><label></label>
      <input name="subtotal" type="text" id="subtotal" value="0" size="20" readonly="readonly" maxlength="10";" style="border:1px solid #ff0000;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" /></td>
      <td bgcolor="#FFFFFF">&nbsp;</td>
      <td align="right" valign="top">&nbsp;</td>
      <td valign="top">&nbsp;</td>
    </tr>
...
%
<input name="nominalppn" type="text" id="nominalppn" readonly="readonly" value="0" size="10" maxlength="10" style="text-align:right;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" /></td>
      <td bgcolor="#FFFFFF">&nbsp;</td>
      <td align="right" valign="top">&nbsp;</td>
      <td valign="top">&nbsp;</td>
    </tr>
    <tr>
      ...
      <td colspan="4" valign="top" bgcolor="#FFFFFF"><input name="totalsales" readonly="readonly" type="text" id="totalsales" value="0" size="20" maxlength="10";" style="border:1px solid #ff0000;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" /></td>
      <td bgcolor="#FFFFFF">&nbsp;</td>
      <td align="right" valign="top">&nbsp;</td>
      <td valign="top">&nbsp;</td>
    </tr>
