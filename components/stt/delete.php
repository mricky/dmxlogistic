...
<form action="proses/stt.php?act=delete" method="POST" name="delete" id="delete" >

  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">

    <tr valign="top">
      <td align="right" bgcolor="#FFFFFF">No STT :</td>
      <td bgcolor="#FFFFFF"><input name="nostt" type="text" id="nostt" size="30" maxlength="100" value="<?php echo $row_edit['NOCONNOTE']; ?>" /></td>
    </tr>
    <tr valign="top">

      <td width="20%" align="right" bgcolor="#FFFFFF">Resi Vendor : </td>

      <td width="80%" bgcolor="#FFFFFF"><label>
        <input name="airwaybill" type="text" id="airwaybill" size="30" maxlength="100" value="<?php echo $row_edit['AIRWAYBILL']; ?>" />
        <input name="id" type="hidden" id="id" value="<?php echo $row_edit['IDSTT']; ?>" />
      </label></td>
    </tr>
