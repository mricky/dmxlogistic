  ...
  <tr>
    ...
    <td colspan="3" align="left" valign="top"><table width="100%" border="1" cellspacing="0" cellpadding="4">
      ...
      <tr valign="top">
        ...
        <td width="28%"align="right"><?php echo $row_detail['from'];?> - <?php echo $row_detail['to'];?></td>
  ...
  <tr valign="top">
    ...
    <td colspan="3" align="center" valign="top"><table align="left" width="1209" height="130" border="1">
      ...
      <tr>
        ...
        <td height="8" colspan="3"><strong>Says : <i><?php echo ucwords(Terbilang($row_ticketing['nominaljual_airline']));?></i>Rupiah</strong></td>
