...
<h1>Edit Merk Kendaraan</h1>
<form action="proses/merkkendaraan.php?act=edit" method="POST" name="edit" id="edit" >
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
    <tr valign="top">
      <td width="20%" align="right" bgcolor="#FFFFFF">Merk Kendaraan* : </td>
      <td width="80%" bgcolor="#FFFFFF"><label>
        <input name="merk" type="text" id="merk" value="<?php echo $row_edit['merk']; ?>" size="30" maxlength="100" />
      </label></td>
    </tr>
    <tr valign="top">
