...
<form action="proses/unitkerja.php?act=edit" method="POST" name="edit" id="edit" >
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
    <tr valign="top">
      <td width="20%" align="right" bgcolor="#FFFFFF">Unit Kerja* : </td>
      <td width="80%" bgcolor="#FFFFFF"><label>
        <input name="unitkerja" type="text" id="unitkerja" value="<?php echo $row_edit['unitkerja']; ?>" size="30" maxlength="100" />
      </label></td>
    </tr>
    <tr valign="top">
