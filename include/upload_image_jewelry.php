...
$query_edit = sprintf("SELECT * FROM ref_images_jewelry WHERE id = '$_GET[id_image]'", $colname_edit);
...
$target = "../" . GALLERIES ."/jewelry/".$folder;
...
<?php
	...
	if($act =='add') {
		 ...
		 if(upload_image_gallery($f_tmp, $target."/".$_FILES['imagefile']['name']))

            {
                ...
                $query = "INSERT INTO ref_images_jewelry (jewelry_id, image_type_id, jewelry_image_name,description) VALUES ('$_GET[id]', '$_POST[image_type]', '$f_nam','$_POST[description]')";
...

	{
...

            {
                ...
                $query = "UPDATE ref_images_jewelry SET jewelry_image_name='$f_nam', image_type_id='$_POST[image_type]', description='$_POST[description]' WHERE id='$_GET[id_image]'";
...
<form action="" method="POST" enctype="multipart/form-data" name="add" id="add" >
  ...
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable">
    ...
    <tr valign="top">
      ...
      <td bgcolor="#FFFFFF"><input name="id" type="text" id="id" value="<?php echo $row_edit['jewelry_id']; ?>" />

        <input name="image_edit" type="text" id="image_edit" value="<?php echo $row_edit['jewelry_image_name']; ?>" /></td>
