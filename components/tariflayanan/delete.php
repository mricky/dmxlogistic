...
cekAkses($_SESSION[akses],"UK-1-3");
...
$query_edit = sprintf("SELECT * FROM layanan_paket WHERE layanan_paket_id = %s", $colname_edit);
...
<h1>Hapus Data Layanan</h1>

<form action="proses/tarif_layanan.php?act=delete" method="POST" name="delete" id="delete" >
  ...
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
    ...
    <tr valign="top">
      ...
      <input name="nama" type="text" id="nama" value="<?php echo $row_edit['layanan_paket_nama']; ?>" size="30" maxlength="100" />
      <input name="id" type="hidden" id="id" value="<?php echo $row_edit['layanan_paket_id']; ?>" />
      </label></td>
    </tr>
