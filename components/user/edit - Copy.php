...
Lihat Data</li>
    ...
    <tr valign="top">
      ...
      <td><ul style="list-style:none;">
          <li>
            <label>
            <input name="checkoutin_1" type="checkbox" id="checkoutin_1" value="IK-1-1" <?php if(strstr($row_edit['akses'],"OI-1-1")) { ?>checked="checked"<?php } ?>/>
              Tambah Data</label>
          </li>
        <li>
            <label>
            <input name="checkoutin_2" type="checkbox" id="checkoutin_2" value="IK-1-2" <?php if(strstr($row_edit['akses'],"OI-1-2")) { ?>checked="checked"<?php } ?>/>
              Edit Data</label>
          </li>
        <li>
            <label>
            <input name="checkoutin_3" type="checkbox" id="checkoutin_3" value="IK-1-3" <?php if(strstr($row_edit['akses'],"OI-1-3")) { ?>checked="checked"<?php } ?>/>
              Hapus Data</label>
          </li>
        <li>
            <label>
            <input name="checkoutin_4" type="checkbox" id="checkoutin_4" value="IK-1" <?php if(strstr($row_edit['akses'],"OI-1")) { ?>checked="checked"<?php } ?>/>
              Lihat Data</label>
          </li>
      </ul></td>
    </tr>
