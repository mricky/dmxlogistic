...
$query_data = "SELECT * from satuan";

if($_GET[cr_txt]<>'' AND $_GET[cr_txt]<>'+') { 

$decode_cr = str_replace("+"," ",$_GET[cr_txt]);

$query_data .=" where KODESATUAN LIKE '%%$decode_cr%%' OR NAMASATUAN LIKE '%%$decode_cr%%'";
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable"> 
  ...
  <tr valign="top" bgcolor="#FFFFFF" class="hide">
        ...
        <td><?php if(strstr($_SESSION['akses'],"UK-1-1")) { ?><a href="index.php?component=satuan&amp;task=add"><img src="images/add_new.png" border="0" /></a><?php } ?></td>
	...
	if(isset($_POST['Search'])) {
		...
		echo "<script>window.location=\"index.php?component=satuan&cr_txt=".str_replace(" ","+",$_POST[cr_txt])."\";</script>";
  ...
  <tr>
    ...
    <th width="699"><strong>Satuan</strong></th>
  ...
  <?php do { ?>
    ...
    <tr valign="top" bgcolor="#FFFFFF">
      ...
      <td><?php echo $row_data['KODESATUAN']; ?></td>

      <td><?php echo $row_data['NAMASATUAN']; ?></td>

      <td align="center" class="hide"><?php if(strstr($_SESSION['akses'],"UK-1-2")) { ?><a href="index.php?component=satuan&amp;task=edit&amp;id=<?php echo $row_data['SATUAN_ID']; ?>"><img src="images/edit_.png" border="0" /></a><?php } ?> <?php if(strstr($_SESSION['akses'],"UK-1-3")) { ?><a href="index.php?component=satuan&amp;task=delete&amp;id=<?php echo $row_data['SATUAN_ID']; ?>" class="ask"><img src="images/delete_.png" border="0" /></a><?php } ?></td>
    </tr>
  ...
  <tr class="hide">
    ...
    <td colspan="3"><?php if(strstr($_SESSION['akses'],"UK-1-1")) { ?><a href="index.php?component=satuan&amp;task=add"><img src="images/add_new.png" border="0" /></a><?php } ?></td>
  </tr>
</table>
