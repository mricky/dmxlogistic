...
<h1>Pricelist Agent Trucking</h1>
<form action="proses/pricelistAgent.php?act=addPriceAgent" method="post" name="addPriceAgent" id="addPriceAgent">
  ...
  <table width="95%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable">
    ...
    <tr valign="top">
      ...
      <td><input name="idhandling" type="hidden" id="idhandling" value="7" size="30" maxlength="100" />
        <input name="handling" type="text" id="handling" size="30" value="TRUCKING" readonly="readonly" maxlength="100"  /></td>
    </tr>
    <tr valign="top">
