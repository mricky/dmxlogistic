...
$query_data = "SELECT * from v_terusan where IDTERUSAN !=0";

if($_GET[cr_txt]<>'' AND $_GET[cr_txt]<>'+') { 

$decode_cr = str_replace("+"," ",$_GET[cr_txt]);

$query_data .=" AND (KODEKOTA LIKE '%%$decode_cr%%' OR NAMAKOTA LIKE '%%$decode_cr%%' OR NAMATERUSAN LIKE '%%$decode_cr%%')";
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable"> 
  ...
  <tr valign="top" bgcolor="#FFFFFF" class="hide">
        ...
        <td><?php if(strstr($_SESSION['akses'],"JS-5-1")) { ?>
          <a href="index.php?component=terusan&amp;task=add"><img src="images/add_new.png" border="0" /></a>
        <?php } ?></td>
  ...
  <td colspan="5" align="right" style="border-bottom:solid 1px #E2EAC1;border-right:solid 1px #E2EAC1;"><form id="search" name="search" method="post" action="">
	...
	if(isset($_POST['Search'])) {
		...
		echo "<script>window.location=\"index.php?component=terusan&cr_txt=".str_replace(" ","+",$_POST[cr_txt])."\";</script>";
  ...
  <tr>
    ...
    <th width="100"><strong>Kode Kota</strong></th>
    <th width="220">Kota</th>
    <th width="220">Kota Terusan</th>
  ...
  <?php do { ?>
    ...
    <tr valign="top" bgcolor="#FFFFFF">
      ...
      <td align="center" class="hide"><?php if(strstr($_SESSION['akses'],"JS-5-2")) { ?><a href="index.php?component=terusan&amp;task=edit&amp;id=<?php echo $row_data['IDTERUSAN']; ?>"><img src="images/edit_.png" border="0" /></a><?php } ?> <?php if(strstr($_SESSION['akses'],"JS-5-3")) { ?><a href="index.php?component=terusan&amp;task=delete&amp;id=<?php echo $row_data['IDTERUSAN']; ?>" class="ask"><img src="images/delete_.png" border="0" /></a><?php } ?></td>
