...
<form action="proses/stt.php?act=edit" method="post" name="edit" id="edit" >
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable">
    ...
    <tr>
      ...
      <td align="right" valign="top"><input type="hidden" name="idorigin" id="idorigin" value="<?php echo $row_edit['IDORIGIN']; ?>"/>
    ...
    <tr valign="top">
      ...
      <td width="17%" bgcolor="#FFFFFF"><input type="hidden" name="iddestination" id="iddestination"  value="<?php echo $row_edit['IDDESC']; ?>"/>
    ...
    <tr valign="top">
      ...
      <td colspan="4" valign="top" bgcolor="#FFFFFF"><label></label>
        &nbsp;<label>
        <input name="tanggalkirim" type="text" class="calendar" id="tanggalkirim" value="<?php echo $row_edit['TGLMANIFEST']; ?>" size="12" maxlength="12"/>
        </label></td>
      <td valign="top" bgcolor="#FFFFFF">&nbsp;</td>
    ...
    <tr valign="top">
      <td colspan="5" align="left" valign="top" bgcolor="#FFFFFF"><span style="color:blue; background-color: #9999ff;">
      ...
      <td valign="top"><input type="hidden" name="idservice" id="idservice" value="<?php echo $row_edit['IDLAYANAN']; ?>" />
    ...
    <tr valign="top">
      ...
      <td colspan="4" valign="top" class="datatable"><select name="statusstt" id="statusstt" style="width:210px;">
        <?php
...
?>
      ...
      <td valign="top"><input type="hidden" name="idhandling" id="idhandling" value="<?php echo $row_edit['IDHANDLING']; ?>" />
    ...
    <tr valign="top">
      ...
      <td colspan="4" bgcolor="#FFFFFF">        <input name="rate" type="text" id="rate" value="<?php echo $row_edit['RATE_KIRIM']; ?>" size="20" maxlength="10";" style="text-align:right;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" onchange="hitungBIAYA();"/>
      / KG</td>
      <td valign="top" bgcolor="#FFFFFF">&nbsp;</td>
      <td align="right">Shipping</td>
      <td bgcolor="#FFFFFF"><input name="costshipping" type="text" id="costshipping" value="<?php echo $row_edit['COST_SHIPPING']; ?>" size="20" maxlength="10";" style="text-align:right;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" onchange="hitungBIAYA();"/></td>
      <td bgcolor="#FFFFFF"><input type="text" name="agentshipping" id="agentshipping" value="<?php echo $row_edit['SHIPPING']; ?>"  placeholder="Cari Pricelist Agent Shipping ..." size="28" readonly="readonly" style="background-color:#fff;border:1px solid #999; height:16px;" onchange="hitungBIAYA();" onclick="NewWindow('index.php?component=stt&amp;task=listShipping&amp;open=window','name','925','450','yes');return false" /></td>
    </tr>
    <tr>
	  ...
	  -->
          <!-- Added by suwondo -->
      <input type="checkbox" name="isdimensi" readonly="readonly" id='isdimensi' value="yes"<?php echo ($row_edit['DIM_P']>0 ? 'checked' : '');?> onclick="calcDimesi();" /> </td>
      ...
      <td valign="top" bgcolor="#FFFFFF"><input type="text" name="agentdelivery" id="agentdelivery" value="<?php echo $row_edit['DELIVERY']; ?>" placeholder="Cari Pricelist Agent Delivery ..." size="28" readonly="readonly" style="background-color:#fff;border:1px solid #999; height:16px;" onclick="NewWindow('index.php?component=stt&amp;task=listDelivery&amp;open=window','name','925','450','yes');return false" /></td>
    </tr>
    <tr>
...
/ kg</td>
      ...
      <td valign="top" bgcolor="#FFFFFF"><input type="text" name="agentwarehouse" id="agentwarehouse" value="<?php echo $row_edit['WAREHOUSE']; ?>" placeholder="Cari Pricelist Agent Warehouse ..." size="28" readonly="readonly" style="background-color:#fff;border:1px solid #999; height:16px;" onclick="NewWindow('index.php?component=stt&amp;task=listWarehouse&amp;open=window','name','925','450','yes');return false" /></td>
    </tr>
    <tr valign="top">
      <td align="right" bgcolor="#FFFFFF">Collie</td>
      <td colspan="4" bgcolor="#FFFFFF"><input name="colly" type="text" id="colly" value="<?php echo $row_edit['COLLY']; ?>" size="20" maxlength="10" style="text-align:right;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" onchange="hitungBIAYA()";"/> 
      / colly</td>
      <td align="right">&nbsp;</td>
      <td align="right">RA</td>
      <td><input name="costra" type="text" id="costra"  size="20" maxlength="10";" value="<?php echo $row_edit['COST_RA']; ?>" style="text-align:right;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" onchange="hitungBIAYA();"/></td>
      <td bgcolor="#FFFFFF"><input type="text" name="agentra" id="agentra" value="<?php echo $row_edit['RA']; ?>" placeholder="Cari Pricelist Agent Regulated ..." size="28" readonly="readonly" style="background-color:#fff;border:1px solid #999; height:16px;" onclick="NewWindow('index.php?component=stt&amp;task=listRegulated&amp;open=window','name','925','450','yes');return false" /></td>
    </tr>
    <tr>
      <td align="right" valign="top" bgcolor="#FFFFFF">Charge Rp.:</td>
      <td colspan="4" valign="top" bgcolor="#FFFFFF"><input name="charge" type="text" id="charge" onchange="grandTotal();" value="<?php echo $row_edit['CHARGE_KIRIM']; ?>" size="20" maxlength="10" style="text-align:right;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" /></td>
      <td bgcolor="#FFFFFF">&nbsp;</td>
      ...
      <td valign="top" bgcolor="#FFFFFF"><input type="text" name="agenttrucking" id="agenttrucking" value="<?php echo $row_edit['TRUCKING']; ?>" placeholder="Cari Pricelist Agent Trucking ..." size="28" readonly="readonly" style="background-color:#fff;border:1px solid #999; height:16px;" onclick="NewWindow('index.php?component=stt&amp;task=listTrucking&amp;open=window','name','925','450','yes');return false" /></td>
    </tr>
    <tr>
      ...
      <td valign="top" bgcolor="#FFFFFF"><input type="text" name="agentgrdh" id="agentgrdh" value="<?php echo $row_edit['GRDH']; ?>" placeholder="Cari Pricelist Agent GRDH ..." size="28" readonly="readonly" style="background-color:#fff;border:1px solid #999; height:16px;" onclick="NewWindow('index.php?component=stt&amp;task=listGRDH&amp;open=window','name','925','450','yes');return false" /></td>
    </tr>
    ...
    <tr>
      ...
      <td valign="top"><input name="costfreight" type="text" id="costfreight" value="<?php echo $row_edit['COST_SMU']; ?>" size="20" maxlength="10";" style="text-align:right;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" onchange="hitungBIAYA();"/></td>
      <td valign="top">No SMU 
        <input name="nosmu" type="text" id="nosmu" size="20"  value="<?php echo $row_edit['NOSMU']; ?>" maxlength="10";" style="text-align:right;" /></td>
    </tr>
    <tr>
      ...
      <td valign="top"><input name="feemarketing" type="text" id="feemarketing" value="<?php echo $row_edit['COST_FEEMARKETING']; ?>" size="20" maxlength="10";" style="text-align:right;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" onchange="hitungBIAYA();"/></td>
      <td valign="top">&nbsp;</td>
    </tr>
    <tr>
      <td align="right" valign="top" bgcolor="#FFFFFF">Sub Total</td>
      <td colspan="4" valign="top" bgcolor="#FFFFFF"><input name="subtotal" type="text" id="subtotal" value="0" size="20" maxlength="10";" style="text-align:right;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" /></td>
      <td bgcolor="#FFFFFF">&nbsp;</td>
      <td align="right" valign="top">Refund Cust</td>
      <td valign="top"><input name="refundcust" type="text" id="refundcust" value="<?php echo $row_edit['COST_REFUNDCUST']; ?>" size="20" maxlength="10";" style="text-align:right;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" onchange="hitungBIAYA();"/></td>
      <td valign="top">&nbsp;</td>
    </tr>
    <tr>
...
<input name="nominalppn" type="text" id="nominalppn"  value="<?php echo $row_edit['PPN']; ?>"  size="10" maxlength="10" style="text-align:right;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" />
      ...
      <td valign="top"><input name="totalcost" type="text" id="totalcost" value="<?php echo $row_edit['TOTALCOST']; ?>" size="20" maxlength="10";" style="text-align:right;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" onchange="hitungBIAYA();"/></td>
      <td valign="top">&nbsp;</td>
    </tr>
    <tr>
      <th align="right" bgcolor="#FFFFFF">Total Sales</th>
      <td colspan="4" bgcolor="#FFFFFF"><input name="totalsales" type="text" id="totalsales" value="<?php echo $row_edit['TOTALSALES']; ?>" size="20" maxlength="10";" style="text-align:right;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" /></td>
      <td bgcolor="#FFFFFF">&nbsp;</td>
      <th align="center" bgcolor="#FFFFFF">Total Profit</th>
      <td align="left" bgcolor="#FFFFFF"><input name="totalprofit" type="text" id="totalprofit" value="<?php echo $row_edit['TOTALPROFIT']; ?>" size="20" maxlength="10";" style="text-align:right;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" onchange="hitungBIAYA();"/></td>
