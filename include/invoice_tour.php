...
www.bimextour.com</td>
    ...
    <td width="26%" rowspan="2" align="center" valign="top"><h2>INVOICE</h2></td>

    <td width="43%" align="left" valign="top"><strong>DATE : </strong><?php echo date("l F j, Y, g:i a"); ?></td>
  ...
  <tr>
    ...
    <td colspan="3" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4">
      ...
      <tr>
        ...
        <td width="9%" valign="top">Nama</td>

        <td width="2%" valign="top">:</td>

        <td width="46%" valign="top"><?php echo $row_ticketing['customer'];?></td>

        <td width="8%" valign="top">Email</td>

        <td width="2%" valign="top">:</td>

        <td width="33%" valign="top"><?php echo $row_ticketing['emailalt'];?></td>
  ...
  <tr>
    ...
    <td colspan="3" align="left" valign="top"><table width="100%" border="1" cellspacing="1" cellpadding="4">
      ...
      <tr valign="top">
        ...
        <td width="4%" align="right"><?php echo $no;$no++;?>.</td>

        <td width="22%"><?php echo $row_detail['nama_tour'];?></td>

        <td width="39%"><?php echo $row_detail['info_tour'];?></td>

        <td width="35%" align="right"><span style="background:#EEE;font-weight:bold;text-decoration:underline;">

          <?php  echo number_format($row_detail['nominaljual_tour'],0,',','.');?>
  ...
  <tr>
    ...
    <td colspan="3" align="right" valign="top"><table align="left" width="1209" height="113" border="1">
      ...
      <tr>
        ...
        <td height="8" colspan="2" align="left"><strong>Says : </strong><i><?php echo ucwords(Terbilang($row_ticketing['nominal_jual']));?> Rupiah</i></td>

        <td height="8" colspan="2" align="right"><strong>Total : <span style="background:#EEE;font-weight:bold;text-decoration:underline;">

          <?php  echo number_format($row_ticketing['nominal_jual'],0,',','.');?>
