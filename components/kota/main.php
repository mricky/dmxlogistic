...
$query_data .=" order by NAMAKOTA asc";
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable"> 
  ...
  <tr valign="top" bgcolor="#FFFFFF" class="hide">
        ...
        <td><?php if(strstr($_SESSION['akses'],"JS-5-1")) { ?>
          <a href="index.php?component=kota&amp;task=add"><img src="images/add_new.png" border="0" /></a>
        <?php } ?></td>
  ...
  <td colspan="5" align="right" style="border-bottom:solid 1px #E2EAC1;border-right:solid 1px #E2EAC1;"><form id="search" name="search" method="post" action="">
      ...
      <input name="cr_txt" type="text" id="cr_txt" placeholder="Find by: code,name"; onclick="this.value='';"<?php echo $_REQUEST['cr_txt'];?>" size="30" maxlength="100" />
	...
	if(isset($_POST['Search'])) {
		...
		echo "<script>window.location=\"index.php?component=kota&cr_txt=".str_replace(" ","+",$_POST[cr_txt])."\";</script>";
  ...
  <?php do { ?>
    ...
    <tr valign="top" bgcolor="#FFFFFF">
      ...
      <td><?php echo $row_data['NAMAAREA']; ?></td>
      <td><?php echo $row_data['NAMAKOTA']; ?></td>
      


      <td align="center" class="hide"><?php if(strstr($_SESSION['akses'],"JS-5-2")) { ?><a href="index.php?component=kota&amp;task=edit&amp;id=<?php echo $row_data['IDKOTA']; ?>"><img src="images/edit_.png" border="0" /></a><?php } ?> <?php if(strstr($_SESSION['akses'],"JS-5-3")) { ?><a href="index.php?component=kota&amp;task=delete&amp;id=<?php echo $row_data['IDKOTA']; ?>" class="ask"><img src="images/delete_.png" border="0" /></a><?php } ?></td>
...
<?php } while ($row_data = mysql_fetch_assoc($data)); ?>
  ...
  <tr class="hide">
    ...
    <td colspan="4"><?php if(strstr($_SESSION[akses],"JS-5-1")) { ?>
      <a href="index.php?component=kota&amp;task=add"><img src="images/add_new.png" border="0" /> </a>
    <?php } ?></td>
