...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable"> 
  ...
  <tr valign="top" bgcolor="#FFFFFF" class="hide">
        ...
        <td width="10%"><?php if(strstr($_SESSION[akses],"PD-7-1")) { ?><a href="index.php?component=gudang&amp;task=add"><img src="images/add_new.png" border="0" /></a><?php } ?></td>
  ...
  <tr>
    ...
    <th width="30%"><strong>Lokasi Kantor</strong></th>
