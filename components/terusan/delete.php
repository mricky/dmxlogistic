...
$query_edit = sprintf("SELECT * FROM terusan WHERE ID = %s", $colname_edit);
...
<form action="proses/terusan.php?act=delete" method="POST" name="delete" id="delete" >
  ...
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
    ...
    <tr valign="top">
      ...
      <input name="nama" type="text" id="nama" size="30" maxlength="100"  value="<?php echo $row_edit['NAMATERUSAN']; ?>"/>
