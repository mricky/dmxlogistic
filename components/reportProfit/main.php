...
include('include/widget_export_daftar_profit.php');
...
?>
  ...
  <input name="Search" type="submit" id="Search" value="Search" />
	...
	if(isset($_POST['Search'])) {
			...
			echo "<script>window.location=\"index.php?component=reportProfit&mulai=".$_POST[mulai]."&sampai=".$_POST[sampai]."&status=".$_POST[status]."&sampai=".$_POST[sampai]."&cr_txt=".str_replace(" ","+",$_POST[cr_txt])."\";</script>";
