...
$query_edit = sprintf("SELECT * FROM penerima WHERE IDPENERIMA = '$_GET[id]'", $colname_edit);
...
<form action="proses/consignee.php?act=edit" method="POST" name="edit" id="edit" >

<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">

    <tr valign="top">
      <td width="20%" align="right" bgcolor="#FFFFFF">Nama * :</td>
      <td width="80%" bgcolor="#FFFFFF"><input name="nama" type="text" id="nama" size="30" maxlength="100"  value="<?php echo $row_edit['NAMAPENERIMA']; ?>"/></td>
    </tr>
    <tr valign="top">
