...
$query_data = "SELECT a.id, a.tgl, a.info, a.noref, b.nopolisi, d.tipekendaraan, c.nama from gl_kkeluar a, gl_masterkendaraan b, gl_kontak c, gl_tipekendaraan d, gl_rtrans e where a.kendaraan = b.nopolisi AND a.driver = c.id AND b.tipekendaraan = d.id AND a.noref = e.no_ref";
...
<h1>Delivery Order Kendaraan<?php if($s_rep=='1') {?> ( Replacement )<?php } ?></h1>
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable"> 
  ...
  <?php do { ?>
    ...
    <tr valign="top" bgcolor="#FFFFFF">
      ...
      <td align="center"><a href="include/print_do.php?id=<?php echo $row_data['id']; ?>" onclick="NewWindow(this.href,'name','765','500','yes');return false" title="Print Delivery Order"><img src="images/_print.png" width="22" height="22" hspace="4" border="0" /></a>
