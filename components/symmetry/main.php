...
$query_data = "SELECT * from ref_dm_symmetry";
if($_GET[cr_txt]<>'' AND $_GET[cr_txt]<>'+') { 
$decode_cr = str_replace("+"," ",$_GET[cr_txt]);
$query_data .=" where symmetry_code LIKE '%%$decode_cr%%' OR symmetry_name LIKE '%%$decode_cr%%'";
}
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable"> 
  <tr valign="top" bgcolor="#FFFFFF" class="hide">
        <td><?php if(strstr($_SESSION['akses'],"JS-5-1")) { ?><a href="index.php?component=symmetry&amp;task=add"><img src="images/add_new.png" border="0" /></a><?php } ?></td>
