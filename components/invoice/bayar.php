...
$queryInvoice = "SELECT * from v_invoice where ID = '$_GET[noreferensi]'";
$invoice = mysql_query($queryInvoice, $con_gl) or die(mysql_error());
$row_invoice = mysql_fetch_assoc($invoice);


mysql_select_db($database_con_gl, $con_gl);
$query = "SELECT * from v_invoice_detail where INVOICE_ID = '$_GET[noreferensi]'";
...
printf($query);
$query_listbayar = "SELECT * from v_pembayaran_invoice where IDINVOICE = '$_GET[noreferensi]'";
...
<div id="divDetail">
  <table width="100%" border="0" cellspacing="0" cellpadding="4" class="datatable" id="cusinfo">
    <tr>
      <th colspan="6" align="left"  style="background:#ed1c24" ><h1 style="color:#FFFFFF; text-shadow:none">Pembayaran Invoice Customer</h1></th>
    </tr>
    <tr>
      <th colspan="6" align="center"  style="background:#FFFFFF">&nbsp;</th>
    </tr>
    <tr>
      <th colspan="6" align="center">INFORMASI TAGIHAN</th>
    </tr>
    <tr>
      ...
      <td valign="top" style="background:#FFF;">INFO STT</td>
      <td width="16%" valign="top" style="background:#FFF;">&nbsp;</td>
      <td width="11%" valign="top" style="background:#FFF;">&nbsp;</td>
      <td width="20%" valign="top" style="background:#FFF;">&nbsp;</td>
    </tr>
    <tr>
      <td align="right" valign="top" style="background:#FFF;">No Invoice :</td>
      <td valign="top" style="background:#FFF;"><?php echo $row_order['KODEINVOICE']; ?></td>
      <td width="10%" align="right" valign="top" style="background:#FFF;">Tgl Connote :</td>
      <td valign="top" style="background:#FFF;"><?php echo $row_order['TGLCONNOTE']; ?></td>
      <td valign="top" style="background:#FFF;">Kota Asal</td>
      <td valign="top" style="background:#FFF;"><?php echo $row_order['KOTAASAL']; ?></td>
    </tr>
    <tr>
      <td width="12%" align="right" valign="top" style="background:#FFF;">Customer :</td>
      <td valign="top" style="background:#FFF;"><?php echo $row_order['NAMACUSTOMER']; ?></td>
      <td align="right" valign="top" style="background:#FFF;">Tgl Manifest :</td>
      <td valign="top" style="background:#FFF;"><?php echo $row_order['TGLMANIFEST']; ?></td>
      <td valign="top" style="background:#FFF;">Kota Tujuan</td>
      <td valign="top" style="background:#FFF;"><?php echo $row_order['kotatujuan']; ?></td>
    </tr>
    <tr>
      ...
      <td align="right" valign="top" style="background:#FFF;">No Connote</td>
      <td valign="top" style="background:#FFF;"><?php echo $row_order['NOCONNOTE']; ?></td>
      <td valign="top" style="background:#FFF;">Layanan</td>
      <td valign="top" style="background:#FFF;"><?php echo $row_order['NAMALAYANAN']; ?> - <?php echo $row_order['NAMAJNSKIRIM']; ?></td>
    </tr>
  </table>
</div>
...
<tr>
    ...
    <th width="78"><strong>No Transfer</strong></th>
  ...
  <?php do { ?>
    <tr valign="top" bgcolor="#FFFFFF">
      ...
      <td><?php echo $row_order_listbayar['NOTRANSFER']; ?></td>
      <td><?php echo $row_order_listbayar['METODEBAYAR']; ?></td>
      <td><?php echo $row_order_listbayar['NAMATIPEBAYAR']; ?></td>            
...
<form action="proses/penerimaanuang.php?act=bayar&IDINVOICE=<?php echo $row_order['INVOICE_ID']?>" method="POST" name="bayar" id="bayar" >
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable">
    <tr>
...
?>
      ...
      <td valign="top" bgcolor="#FFFFFF">Total Tagihan   Rp :
        <label></label>
        <input name="totalsewa" type="text" id="totalsewa"  value="<?php echo $row_invoice['TOTAL_CHARGE']; ?>" size="20" maxlength="10" style="text-align:right;" /></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td colspan="2" valign="top" bgcolor="#FFFFFF"><input name="notransfer" type="text" id="notransfer" size="20" maxlength="10";" style="text-align:right;" />
      <input name="idinvoice" type="hidden" id="idinvoice" size="20" maxlength="10";" style="text-align:right;" value="<?php echo $row_order['INVOICE_ID']; ?>"  /></td>
      <td valign="top" bgcolor="#FFFFFF">Kekurangan Rp :
        <?php
		  $kekurangan = $row_invoice['TOTAL_CHARGE'] - $row_invoice['TOTALBAYAR'];
		  ?>
