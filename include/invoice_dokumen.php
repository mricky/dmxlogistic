...
www.bimextour.com</td>
    ...
    <td width="30%" rowspan="2" align="center" valign="top"><h2>INVOICE</h2></td>

    <td width="35%" align="left" valign="top"><strong>DATE : </strong><?php echo date("l F j, Y, g:i a"); ?></td>
  ...
  <tr>
    ...
    <td colspan="3" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4">
      ...
      <tr>
        ...
        <td width="22%" valign="top"><?php echo $row_ticketing['emailalt'];?></td>
  ...
  <tr>
    ...
    <td colspan="3" align="left" valign="top" style="border:solid 1px #000;border-left:none;"><strong>Details</strong><strong></strong></td>
  ...
  <tr>
    ...
    <td colspan="3" align="left" valign="top"><table width="100%" border="1" cellspacing="0" cellpadding="4">
      ...
      <tr valign="top">
        ...
        <td width="22%"><?php echo $row_detail['nama_dokumen'];?></td>

        <td width="15%"><?php echo $row_detail['dokumen'];?> -<?php echo $row_detail['no_dokumen'];?></td>

        <td width="45%"><?php echo $row_detail['info_dokumen'];?></td>

        <td width="16%" align="right"><span style="background:#EEE;font-weight:bold;text-decoration:underline;">

          <?php  echo number_format($row_detail['nominaljual_dokumen'],0,',','.');?>
  ...
  <tr>
    ...
    <td colspan="3" align="right" valign="top"><table align="left" width="1209" height="113" border="1">
      ...
      <tr>
        ...
        <td height="8" colspan="2" align="left"><strong>Says : </strong><i><?php echo ucwords(Terbilang($row_ticketing['nominaljual_dokumen']));?> Rupiah</i></td>

        <td height="8" colspan="2" align="right"><strong>Total : <span style="background:#EEE;font-weight:bold;text-decoration:underline;">

          <?php  echo number_format($row_ticketing['nominaljual_dokumen'],0,',','.');?>
