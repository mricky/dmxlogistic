...
include('include/widget_export_daftar_cost.php');
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable"> 
  ...
  <td colspan="14" align="right" style="border-bottom:solid 1px #E2EAC1;border-right:solid 1px #E2EAC1;"><form id="search" name="search" method="post" action="">
          <label> Status : 
...
?>
  ...
  <input name="Search" type="submit" id="Search" value="Search" />
	...
	if(isset($_POST['Search'])) {
			...
			echo "<script>window.location=\"index.php?component=reportCost&mulai=".$_POST[mulai]."&status=".$_POST[status]."&sampai=".$_POST[sampai]."&cr_txt=".str_replace(" ","+",$_POST[cr_txt])."\";</script>";
  ...
  <tr>
    ...
    <th colspan="10" align="center">Biaya</th>
  ...
  <?php do { ?>
    ...
    <tr class="hide">
      ...
      <td colspan="19"><table border="0" align="left" width="50%">
