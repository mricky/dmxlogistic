...
$query_data = "SELECT
                    b.prov_name,
                    c.administratif_name,
                    a.kota_name
                    FROM
                    ref_city AS a
                    INNER JOIN provinces AS b ON b.prov_id = a.prov_id
                    INNER JOIN ref_wilayah_administratif AS c ON c.administratif_id = a.administratif_id";
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable"> 
  ...
  <tr>
    <th width="220"><strong>Provice</strong></th>
    <th width="220">Administratif Name</th>
    <th width="220"><strong>City Name</strong></th>
  ...
  <?php do { ?>
    <tr valign="top" bgcolor="#FFFFFF">
      ...
      <td><?php echo $row_data['administratif_name']; ?></td>
      <td><?php echo $row_data['kota_name']; ?></td>
