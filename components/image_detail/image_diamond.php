...
$query_data = "select  a.id, a.diamond_id, a.dm_image_name,b.image_type,a.description from ref_images_dm a inner join ref_image_type b ON (a.image_type_id = b.id) where a.diamond_id = '$_GET[id]'";
...
list($code, $item_type_name) = mysql_fetch_row(mysql_query("select a.diamond_code,b.item_tipe_name from diamonds a inner join item_type b on( a.item_type_id = b.item_tipe_code) where a.diamond_code = '$_GET[id]' AND a.item_type_id = '$_GET[item_type]'"));
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable"><tr class="hide"><td colspan="4" align="right"><table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable">
  <tr class="hide">
    <td width="146"><a href="include/upload_image_diamond.php?act=add&id=<?php echo $_GET['id'];?>" onclick="NewWindow(this.href,'name','920','425','yes');return false"><img src="images/add_new.png" border="0" /></a></td>
    <td align="right">&nbsp;</td>
    <td align="right">&nbsp;</td>
    <td align="right">&nbsp;</td>
    <td align="right">&nbsp;</td>
  ...
  <tr valign="top" bgcolor="#FFFFFF">
    ...
    <td align="left"><?php echo $row_data['dm_image_name'];?></td>
    <td align="left"><img src="<?php echo "galleries/diamond/".$row_data['image_type']."/".$row_data['dm_image_name']; ?>" alt="" width="150" height="100" /></td>
    <td align="left"><?php echo $row_data['description'];?></td>
    <td align="left"><?php if(strstr($_SESSION['akses'],"JS-5-2")) { ?>
      <a href="include/upload_image_diamond.php?act=edit&id=<?php echo $_GET['id'];?>&id_image=<?php echo $row_data['id'];?>" onclick="NewWindow(this.href,'name','920','425','yes');return false"><img src="images/edit_.png" alt="edit" border="0" /></a>
      <?php } ?>
