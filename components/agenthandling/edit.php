...
$query_edit = sprintf("SELECT * FROM agenthanding WHERE ID = '$_GET[id]'", $colname_edit);
...
<h1>Edit Agent Handling</h1>

<form action="proses/agenthandling.php?act=edit" method="POST" name="edit" id="edit" >

<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">

    <tr valign="top">
      <td width="20%" align="right" bgcolor="#FFFFFF">Nama * :</td>
      <td width="80%" bgcolor="#FFFFFF"><input name="nama" type="text" id="nama" size="30" maxlength="100"  value="<?php echo $row_edit['NAMA']; ?>"/>
