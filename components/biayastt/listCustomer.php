...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable">
	...
	while(list($id, $nama, $alamat,$telepon,$fax,$hp,$email,$marketing) = mysql_fetch_row($query)){
		...
		echo "<td>$nama</td><td>$alamat</td><td>$telepon</td><td>$hp</td><td>$email</td><td>$marketing</td><td align='center'><input type='button' value='pilih' onclick=\"javascript: window.opener.document.getElementById('idcustomer').value='$id';
window.opener.document.getElementById('custaddress').innerHTML='$alamat'; 
window.opener.document.getElementById('custtelpon').innerHTML='$telepon'; 
window.opener.document.getElementById('custemail').innerHTML='$email'; 
window.opener.document.getElementById('custmarketing').innerHTML='$marketing'; 
window.opener.document.getElementById('customer').value='$nama'; window.close(1000);\" /></td>";
