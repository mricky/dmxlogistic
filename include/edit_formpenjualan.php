...
<table width="100%" border="0" cellspacing="0" cellpadding="5" class="datatable">
  ...
  <tr>
    ...
    <th width="42%" align="center"><strong>Barang  </strong></th>
  ...
  <?php
	...
	$query_kend = "select distinct b.nopol, a.jenis, b.tipe from gl_jkendaraan a ,gl_kendaraan b, gl_jenbar c where a.id = b.jenis AND c.barang='$row_tr[brg_id]' AND c.jenis = a.id order by a.jenis, b.nopol";
...
?>
        ...
        <label id="divListKendaraan">
                ...
                <select name="kendaraan" id="kendaraan" style="width:240px;" onChange="getHargaKendaraan();">

  <option value="">Pilih Kendaraan</option>

  <?php if($total_kend > 0) { do { ?>

  <option value="<?php echo $row_kend['nopol'];?>" <?php if($row_kend['nopol']==$row_tr['kendaraan']) { ?>selected="selected"<?php } ?>><?php echo $row_kend['jenis'];?>-<?php echo $row_kend['tipe'];?> ( <?php echo $row_kend['nopol'];?> )</option>
...
?>
        ...
        <td align="center" ><label>
          ...
          <textarea name="transaksi" cols="35" rows="2" id="transaksi"><?php echo $row_getvalue['transaksi']; ?></textarea>
        ...
        <td align="center" ><label></label>
            ...
            <input name="add" type="button" id="add" value="&nbsp;" onclick="ajaxManagePenjualan('Simpan',<?php echo $row_getvalue['id']; ?>);" class="checkbutton" title="Simpan Transaksi"/>
