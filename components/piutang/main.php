...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable"> 
  ...
  <?php
	...
	if(isset($_POST['Search'])) {
			...
			echo "<script>window.location=\"index.php?component=piutang&mulai=".$_POST[mulai]."&sampai=".$_POST[sampai]."&cr_txt=".str_replace(" ","+",$_POST[cr_txt])."\";</script>";
  ...
  <?php do { ?>
      ...
      <tr valign="top" bgcolor="#FFFFFF">
        ...
        <td align="center" class="hide"><?php if(strstr($_SESSION['akses'],"L-3")) { ?>
        <a href="index.php?component=piutang&amp;task=bayar&amp;noreferensi=<?php echo $row_data[IDSTT];?>+&amp;open=window" onclick="NewWindow(this.href,'name','1300','600','yes');return false"><img src="images/transactions.png" alt="image" border="0" />Bayar</a>
          <?php } ?>          </td>
      </tr>
