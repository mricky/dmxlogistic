...
$url = base_url("index.php?component=agent");
...
if (isset($error)) {
	...
	if($act =='add') {
            ...
            $query = "INSERT INTO agent (KODEAGENT,NAMAAGENT,ALAMAT,TELEPON,FAX,HP,EMAIL,NPWP,BANK,ACCOUNTNUMBER,ATASNAMA)"

                    . " VALUES ('$kode','$_POST[nama]','$_POST[alamat]','$_POST[telepon]','$_POST[fax]','$_POST[hp]','$_POST[email]','$_POST[npwp]','$_POST[bank]','$_POST[rekening]','$_POST[atas_nama]');";
          ...
          // print_r($query);
            ...
            $query = "UPDATE agent SET NAMAAGENT='$_POST[nama]',ALAMAT='$_POST[alamat]',TELEPON='$_POST[telepon]',FAX='$_POST[fax]',HP='$_POST[hp]',EMAIL='$_POST[email]',NPWP='$_POST[npwp]',BANK='$_POST[bank]',ACCOUNTNUMBER='$_POST[rekening]',ATASNAMA='$_POST[atas_nama]' WHERE ID_AGENT='$_POST[id]'";
		...
		//break;
            ...
            $query = "delete from agent where ID_AGENT='$_POST[id]'";
