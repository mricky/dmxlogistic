...
$totalRows_list_tr = mysql_num_rows($list_tr);
			...
			<?php if($row_list_tr['id'] <> $_GET[refid] AND $totalRows_list_tr > 1) {  ?>
			  <tr bgcolor="#FFFFFF">
			    ...
			    <td width="10%" align="center"><?php echo number_format($row_list_tr['total'],0,',','.').",-"; ?></td>
			    <td align="center"><?php echo $row_list_tr['transaksi']; ?></td>
			    <td width="10%" align="center">
			      <label>
        <button value="<?php echo $row_list_tr['id']; ?>" onclick="ajaxEditFormKasmasuk(<?php echo $row_list_tr['id']; ?>);" type="button" class="editbutton" title="Edit Transaksi">&nbsp;</button></label><label>
...
?>
              ...
              <td width="10%" align="center"><label></label>
                  <label>
                  <input name="add" type="button" id="add" value="&nbsp;" onclick="ajaxManageKasmasuk('Simpan',<?php echo $row_list_tr['id']; ?>);" class="checkbutton" title="Simpan Transaksi"/>
              </label></td>
            </tr>
			<?php } ?>
