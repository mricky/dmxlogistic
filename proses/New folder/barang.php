...
$url = "index.php?component=barang";
...
if (trim($_POST['kelompok']) == '') {
	...
	$error[] = '- Kelompok harus dipilih !!!';

}

if (trim($_POST['barang']) == '') {

	$error[] = '- Barang harus diisi !!!';
...
if (isset($error)) {
	...
	$query = "INSERT INTO gl_barang (id, kelompok, barang, keterangan) VALUES (NULL, '$_POST[kelompok]', '$_POST[barang]', '$_POST[keterangan]')";

	}else if($act=='edit'){

	$query ="UPDATE gl_barang SET barang='$_POST[barang]', kelompok='$_POST[kelompok]', keterangan='$_POST[keterangan]' WHERE id='$_POST[id]'";

	}else{

	$query = "delete from gl_barang where id='$_POST[id]'";
