...
<table width="710" border="0" align="center" cellpadding="8" cellspacing="0" style="border:solid 1px #000000;">
  <tr>
    <td colspan="5" align="center" valign="top" style="border-bottom:solid 1px #000;"><h2>ADENDUM</h2><br />
        NOMOR :<?php echo $_GET['noadendum'];?></td>
  </tr>
  <tr>
    <td colspan="5" align="justify" valign="top">Pada hari ini Jumat, tanggal .. bulan ..  tahun .. telah dibuat dan ditandatangani suatu perjanjian Sewa Kendaraan oleh dan antara :
      <ol>
      <li><strong></strong> <?php echo $row_gudang[atasnama];;?> berkedudukan di Bandung, berkantor pusat di  <?php echo $row_gudang[keterangan];?>, yang dalam hal ini diwakili oleh Rubby, berdasarkan surat Kuasa Direktur utama <?php echo $row_gudang[atasnama];;?>  No. 150/SKH-DIR/AMG/XI/2015 tanggal  21 November 2015 oleh karenanya berhak dan berwenang bertindak untuk dan atas nama <?php echo $row_gudang[atasnama];?>  beralamat di <?php echo $row_gudang[keterangan];?>, yang selanjutnya disebut sebagai PIHAK PERTAMA--------------------------------------------------------------------------------------------------------------</li>
      <li><strong></strong><?php echo $row_adendum[atasnama];?>  beralamat <?php echo $row_adendum[alamat];?>, yang dalam hal ini diwakili oleh <?php echo $row_adendum[atasnama];?>  sebagai DIREKTUR , karenanya berhak dan berwenang bertindak untuk dan atas nama <?php echo $row_adendum[atasnama];?>, yang selanjutnya disebut sebagai PIHAK KEDUA---------------------------------------------------------------------- </li>
    </ol>
      ...
      <ol>
        <li><strong></strong>Bahwa PARA PIHAK tersebut diatas menyetujui untuk Perjanjian Pengantian unit Sewa kendaraan berdasarkan Perjanjian Sewa Kendaraan antara <?php echo $row_gudang[atasnama];;?>  dengan <?php echo $row_adendum[atasnama];?>, dengan unit kendaraan sebagai berikut :</li>
    </ol></td>    
  </tr>
  <tr>
    <td colspan="5" align="justify" valign="top">&nbsp;</td>
  </tr>
  <tr>
    <td colspan="5" align="left" valign="top"><ol start="1" type="1">
      ...
      <p>Selain dari penggantian unit masa sewa kendaraan, hal-hal lain tetap merujuk kepada surat perjanjian sewa kendaraan NOMOR : <span style="border-bottom:solid 1px #000;"><?php echo $_GET['kontrak'];?></span><br />
        antara RUBBY dalam hal ini bertindak sah atas nama <?php echo $row_gudang[atasnama];;?> dengan DENI APRIANSYAH, dalam hal ini bertindak sah atas nama <?php echo $row_adendum[atasnama];?>. </p>
  ...
  <tr>
    <th colspan="2" align="left" valign="top">PIHAK PERTAMA</th>
    <th align="center" valign="top">&nbsp;</th>
    <th colspan="2" align="left" valign="top">PIHAK KEDUA</th>
  </tr>
  <tr>
