...
$query_data = "SELECT * from ref_dm_shape";
if($_GET[cr_txt]<>'' AND $_GET[cr_txt]<>'+') { 
$decode_cr = str_replace("+"," ",$_GET[cr_txt]);
$query_data .=" where id LIKE '%%$decode_cr%%' OR cut_name LIKE '%%$decode_cr%%'";
}
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable"> 
  <tr valign="top" bgcolor="#FFFFFF" class="hide">
        <td><?php if(strstr($_SESSION['akses'],"JS-5-1")) { ?><a href="index.php?component=shape&amp;task=add"><img src="images/add_new.png" border="0" /></a><?php } ?></td>
	...
	if(isset($_POST['Search'])) {
		echo "<script>window.location=\"index.php?component=polish&cr_txt=".str_replace(" ","+",$_POST[cr_txt])."\";</script>";
	}
	?></td>
  </tr>
  <tr>
    ...
    <th width="76"><strong>Image</strong></th>
  ...
  <?php do { ?>
    <tr valign="top" bgcolor="#FFFFFF">
      <td><?php echo $row_data['shape_code']; ?></td>
      <td><?php echo $row_data['shape_name']; ?></td>      
      <td><label> <img width="95" height="75" src="<?php echo "galleries/".$row_data['shape_image']; ?>" /></td>
      <td><?php echo $row_data['description']; ?></td>          
      <td align="center" class="hide"><?php if(strstr($_SESSION['akses'],"JS-5-2")) { ?><a href="index.php?component=shape&amp;task=edit&amp;id=<?php echo $row_data['shape_code']; ?>"><img src="images/edit_.png" border="0" /></a><?php } ?> <?php if(strstr($_SESSION['akses'],"JS-5-3")) { ?><a href="index.php?component=shape&amp;task=delete&amp;id=<?php echo $row_data['shape_code']; ?>" class="ask"><img src="images/delete_.png" border="0" /></a><?php } ?></td>
    </tr>
  ...
  <?php } ?>
  <tr class="hide">
    <td colspan="4"><?php if(strstr($_SESSION[akses],"JS-5-1")) { ?><a href="index.php?component=jwcategory&amp;task=add"><img src="images/add_new.png" border="0" />
    </a><?php } ?></td>
  </tr>
</table>