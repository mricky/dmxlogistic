...
<?php
cekAkses($_SESSION[akses],"PD-5-2");
$colname_edit = "-1";
if (isset($_GET['id'])) {
...
<h1>Edit Katagori Arsip</h1>
<form action="proses/katagoriarsip.php?act=edit" method="POST" name="edit" id="edit" >
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable">
    <tr valign="top">
      <td width="20%" align="right" bgcolor="#FFFFFF">Katagori* : </td>
      <td width="80%" bgcolor="#FFFFFF"><label>
        <input name="katagori" type="text" id="katagori" value="<?php echo $row_edit['katagori']; ?>" size="30" maxlength="100" />
      </label></td>
    </tr>
    <tr valign="top">
