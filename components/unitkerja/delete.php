...
$query_edit = sprintf("SELECT * FROM gl_unitkerja WHERE id = %s", $colname_edit);
...
<h1>Hapus Data Unit Kerja </h1>
<form action="proses/unitkerja.php?act=delete" method="POST" name="delete" id="delete" >
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
    <tr valign="top">
      <td width="20%" align="right" bgcolor="#FFFFFF">Unit Kerja* : </td>
      <td width="80%" bgcolor="#FFFFFF"><label>
        <input name="unitkerja" type="text" id="unitkerja" value="<?php echo $row_edit['unitkerja']; ?>" size="30" maxlength="100" onFocus="this.blur();"/>
      </label></td>
    </tr>
    <tr valign="top">
