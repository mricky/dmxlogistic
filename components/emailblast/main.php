...
mysql_select_db($database_con_gl, $con_gl);
$query_data = "select a.nama, a.alamat, a.nohp,a.email,a.email_send, a.send_by, a.send_status, b.area
from email_blast as a, gl_area as b where a.area = b.id";
if(isset($_GET[cr_txt]) AND $_GET[cr_txt]<>'' AND $_GET[cr_txt]<>'+') { 
$decode_cr = str_replace("+"," ",$_GET[cr_txt]);
$query_data .=" AND (a.email LIKE '%%$decode_cr%%' OR a.nohp LIKE '%%$decode_cr%%' OR a.tlp email '%%$decode_cr%%')";
}
if(isset($_GET[cr_kel]) AND $_GET[cr_kel]<>'ALL') { 
$query_data .=" AND a.area ='$_GET[cr_kel]'";
}
$query_data .=" ORDER BY a.area";
...
?>
<h1>Daftar Informasi Customer</h1>
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable"> 
  <tr valign="top" bgcolor="#FFFFFF" class="hide">
        <td><?php if(strstr($_SESSION[akses],"PD-7-1")) { ?><a href="index.php?component=emailblast&task=add"><img src="images/add_new.png" border="0" /></a><?php } ?></td>
...
<label>
	...
	if(isset($_POST['Search'])) {
		echo "<script>window.location=\"index.php?component=emailblast&cr_kel=".$_POST[cr_kel]."&cr_txt=".str_replace(" ","+",$_POST[cr_txt])."\";</script>";
	}
	?></td>
  </tr>
  <tr>
    <th width="127"><strong>Kota/Area Ops</strong></th>
    <th width="316"><strong>Nama Customer</strong></th>
    <th width="424"><strong>Alamat</strong></th>
    <th width="109">No. HP </th>
    <th width="109">Email </th>
    <th width="109">Tgl Kirim</th>
    <th width="109">Dikirim Oleh</th>
