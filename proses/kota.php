...
$url = base_url("index.php?component=kota");
...
if ($act=='add')
{
	...
	$query_cekno = "select NAMAKOTA from kota where NAMAKOTA='$nop'";
	...
	if($total_cekno > 0) { 
		...
		$error[] = '- NAMA KOTA  '.$nop.' sudah terdaftar';
...
if (isset($error)) {
	...
	if($act =='add') {
            ...
            $query = "INSERT INTO kota (KODEKOTA,IDAREA,NAMAKOTA,CREATED_AT)"

                    . " VALUES ('$_POST[kode]','$_POST[area]','$_POST[nama]',$today);";
           ...
           //print_r($query);
            ...
            $query = "UPDATE kota SET KODEKOTA = '$_POST[kode]', IDAREA='$_POST[area]', NAMAKOTA='$_POST[nama]' WHERE IDKOTA='$_POST[id]'";
		...
		//break;
            ...
            $query = "delete from kota where IDKOTA='$_POST[id]'";
