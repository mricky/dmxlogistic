...
window.opener.document.getElementById('charge').value=$CHARGE*$weight;

 var charge = $CHARGE*$weight;
 // var othercharge = parseInt(window.opener.document.getElementById('othercharge').value);	
 	
 var othercharge = parseInt(window.opener.document.getElementById('othercharge').value);	
 var chargepacking = parseInt(window.opener.document.getElementById('chargepacking').value);	
 var totalcharge  = charge + othercharge + chargepacking;	 
 window.opener.document.getElementById('subtotal').value = totalcharge;	


 var nominalppn = parseInt(window.opener.document.getElementById('nominalppn').value);
 var chargeinsurace = parseInt(window.opener.document.getElementById('chargeinsurace').value);
 var totalsales =  totalcharge + nominalppn + chargeinsurace;
   
 window.opener.document.getElementById('totalsales').value = totalsales;
