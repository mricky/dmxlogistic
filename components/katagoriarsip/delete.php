...
<?php
cekAkses($_SESSION[akses],"PD-5-3");
$colname_edit = "-1";
if (isset($_GET['id'])) {
  $colname_edit = (get_magic_quotes_gpc()) ? $_GET['id'] : addslashes($_GET['id']);
}
mysql_select_db($database_con_gl, $con_gl);
$query_edit = sprintf("SELECT * FROM gl_katagoriarsip WHERE id = %s", $colname_edit);
...
<h1>Hapus Katagori Arsip</h1>
<form action="proses/katagoriarsip.php?act=delete" method="POST" name="delete" id="delete" >
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable">
    <tr valign="top">
      <td width="20%" align="right" bgcolor="#FFFFFF">Katagori* : </td>
      <td width="80%" bgcolor="#FFFFFF"><label>
        <input name="katagori" type="text" id="katagori" value="<?php echo $row_edit['katagori']; ?>" size="30" maxlength="100" onFocus="this.blur();"/>
      </label></td>
    </tr>
    <tr valign="top">
