...
$query_edit = sprintf("SELECT * FROM kota WHERE IDKOTA = %s", $colname_edit);
...
<form action="proses/kota.php?act=delete" method="POST" name="delete" id="delete" >
  ...
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
    ...
    <tr valign="top">
      ...
      <input name="nama" type="text" id="nama" size="30" maxlength="100"  value="<?php echo $row_edit['NAMAKOTA']; ?>"/>
      <input name="id" type="hidden" id="id" value="<?php echo $row_edit['IDKOTA']; ?>" />
      </label></td>
    </tr>
