...
$query_harga = "select a.supir from gl_jenbar a where a.barang = '$bar' and a.area = '$_SESSION[area]' and a.jenis = (select tipekendaraan from gl_masterkendaraan where nopolisi ='$kid')";
