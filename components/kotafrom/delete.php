...
<h1>Delete Departure City</h1>
<form action="proses/kotafrom.php?act=delete" method="POST" name="delete" id="delete" >
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0">
    <tr valign="top">
      <td width="20%" align="right" bgcolor="#FFFFFF">Kode* </td>
      <td width="80%" bgcolor="#FFFFFF"><label>
        <input name="kode_airport" type="text" id="kode_airport" value="<?php echo $row_edit['kode_airport']; ?>" size="30" maxlength="100" onFocus="this.blur();"/>
      </label></td>
    </tr>
    <tr valign="top">
      <td align="right" bgcolor="#FFFFFF">City * :</td>
      <td bgcolor="#FFFFFF"><input name="airport" type="text" id="airport" value="<?php echo $row_edit['airport']; ?>" size="30" maxlength="100" onfocus="this.blur();"/></td>
    </tr>
    <tr valign="top">
