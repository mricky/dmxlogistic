...
<?php
cekAkses($_SESSION[akses],"PD-7-4");
// ---
...
?>
    ...
    <tr valign="top">
      ...
      <td bgcolor="#FFFFFF"><label>
        <input name="q" type="text" id="q" size="20" maxlength="100" value="Cari Akun ..." onClick="this.value='';" onChange="findAkunCOA();">
