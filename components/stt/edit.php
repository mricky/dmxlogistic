...
$tpenjualan = $row_edit['CHARGEKIRIM'] ; 
...
<form action="proses/stt.php?act=edit" method="post" name="edit" id="edit" >
  <table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable">
    ...
    <tr valign="top">
      ...
      <td colspan="4" valign="top" bgcolor="#FFFFFF"><input name="airwaybill" type="text" id="airwaybill" size="30" maxlength="100" value="<?php echo $row_edit['AIRWAYBILL']; ?>" /></td>
...
/ colly</td>
    ...
    <tr valign="top">
      ...
      <td colspan="4" valign="top" bgcolor="#FFFFFF"><input name="nosmu" type="text" id="nosmu" size="25"  value="<?php echo $row_edit['NOSMU']; ?>" maxlength="20";" style="text-align:right;" /></td>
      <td valign="top" bgcolor="#FFFFFF">&nbsp;</td>
      <td align="right">&nbsp;</td>
      <td bgcolor="#FFFFFF">&nbsp;</td>
    </tr>
...
/ KG</td>
    ...
    <tr>
      ...
      <td colspan="4" valign="top" bgcolor="#FFFFFF"><input name="othercharge" type="text" id="othercharge" value="<?php echo $row_edit[
	  'OTHERCHARGE'];?>" size="20" maxlength="10";" style="text-align:right;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" onchange="grandTotal();"/></td>
      <td bgcolor="#FFFFFF">&nbsp;</td>
      <td align="right" valign="top">&nbsp;</td>
      <td valign="top">&nbsp;</td>
    </tr>
    ...
    <tr>
      ...
      <td colspan="4" valign="top" bgcolor="#FFFFFF"><input name="subtotal" type="text" id="subtotal" readonly="readonly" value="<?php echo $row_edit['SUBTOTAL']; ?>" size="20" maxlength="10";" style="border:1px solid #ff0000;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" /></td>
      <td bgcolor="#FFFFFF">&nbsp;</td>
      <td align="right" valign="top">&nbsp;</td>
      <td valign="top">&nbsp;</td>
    </tr>
...
<input name="nominalppn" type="text" id="nominalppn"  value="<?php echo $row_edit['PPN']; ?>"  size="10" maxlength="10" style="text-align:right;" onkeyup="javascript:if(this.value=='' || isNaN(this.value)) this.value='0';" />
    ...
    <tr>
      ...
      <td bgcolor="#FFFFFF">&nbsp;</td>
      <td align="left" bgcolor="#FFFFFF">&nbsp;</th>
