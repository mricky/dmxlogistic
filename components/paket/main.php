...
$query_data = "SELECT * from jenis_paket";

if($_GET[cr_txt]<>'' AND $_GET[cr_txt]<>'+') { 

$decode_cr = str_replace("+"," ",$_GET[cr_txt]);

$query_data .=" where jenis_paket_name LIKE '%%$decode_cr%%'";
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable"> 
  ...
  <tr valign="top" bgcolor="#FFFFFF" class="hide">
        ...
        <td><?php if(strstr($_SESSION['akses'],"UK-1-1")) { ?><a href="index.php?component=paket&amp;task=add"><img src="images/add_new.png" border="0" /></a><?php } ?></td>
	...
	if(isset($_POST['Search'])) {
		...
		echo "<script>window.location=\"index.php?component=paket&cr_txt=".str_replace(" ","+",$_POST[cr_txt])."\";</script>";
  ...
  <?php do { ?>
    ...
    <tr valign="top" bgcolor="#FFFFFF">
      ...
      <td align="center" class="hide"><?php if(strstr($_SESSION['akses'],"UK-1-2")) { ?><a href="index.php?component=paket&amp;task=edit&amp;id=<?php echo $row_data['jenis_paket_id']; ?>"><img src="images/edit_.png" border="0" /></a><?php } ?> <?php if(strstr($_SESSION['akses'],"UK-1-3")) { ?><a href="index.php?component=paket&amp;task=delete&amp;id=<?php echo $row_data['jenis_paket_id']; ?>" class="ask"><img src="images/delete_.png" border="0" /></a><?php } ?></td>
    </tr>
  ...
  <tr class="hide">
    ...
    <td colspan="3"><?php if(strstr($_SESSION['akses'],"UK-1-1")) { ?><a href="index.php?component=paket&amp;task=add"><img src="images/add_new.png" border="0" /></a><?php } ?></td>
  </tr>
</table>
