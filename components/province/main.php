...
$query_data = "SELECT
                        ...
                        FROM
                        provinces AS a
                        INNER JOIN nations AS b ON b.negara_iso = a.negara_iso
                        INNER JOIN ref_zone AS c ON c.zone_id = a.zone_id";
if($_GET[cr_txt]<>'' AND $_GET[cr_txt]<>'+') { 
$decode_cr = str_replace("+"," ",$_GET[cr_txt]);
$query_data .=" where b.prov_name LIKE '%%$decode_cr%%' OR b.negara_name LIKE '%%$decode_cr%%'";
}
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable"> 
  ...
  <tr>
    <th width="220"><strong>Nation</strong></th>
    <th width="220">Zone</th>
    <th width="220"><strong>Province</strong></th>
  ...
  <?php } ?>
  <tr class="hide">
    <td colspan="4"><?php if(strstr($_SESSION[akses],"JS-5-1")) { ?><a href="index.php?component=province&amp;task=add"><img src="images/add_new.png" border="0" />
    </a><?php } ?></td>
  </tr>
</table>