...
<table width="1200" border="0" align="center" cellpadding="6" cellspacing="0" style="border:solid 1px #000000;">
  ...
  <tr>
    ...
    <td width="39%" rowspan="2" align="left" valign="top"><h2><img src="../m_logo.png" alt="" width="140" height="34" /></h2>
  ...
  <tr>
    ...
    <td align="left" valign="top"><strong>NOMOR : <?php echo $_GET['referensi'];?></strong></td>
  ...
  <tr>
    ...
    <td colspan="3" align="left" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="4">
      ...
      <tr>
        ...
        <td width="34%" valign="top"><?php echo $row_ticketing['customer'];?></td>
  ...
  <tr valign="top">
    ...
    <td colspan="3" align="center" valign="top"><table align="left" width="1209" height="130" border="1">
      ...
      <tr>
        ...
        <td height="8" colspan="3"><strong>Says : <i><?php echo ucwords(Terbilang($row_ticketing['nominal_jual']));?></i>Rupiah</strong></td>
