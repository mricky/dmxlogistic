...
$act = $_GET[act];
$url = "index.php?component=pembayaranhutang";
...
if (isset($error)) {
	...
	if($act =='add') {
	$query = "INSERT INTO gl_rtrans (no_ref, tgl, gudang, keterangan, kontak, jenis, gudang) VALUES ('$_POST[noreferensi]', '$_POST[tanggal]', '$_POST[gudang]', '$_POST[keterangan]', '$_POST[kepada]', '$_POST[jenis]','$_POST[gudang]')";
  ...
  mysql_query($query_add, $con_gl);
	...
	$query ="UPDATE gl_rtrans SET tgl='$_POST[tanggal]', gudang='$_POST[gudang]', kontak='$_POST[kepada]', keterangan='$_POST[keterangan]' WHERE no_ref='$_POST[noreferensi]'";
