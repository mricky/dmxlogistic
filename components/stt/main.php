...
<h1>Daftar Surat Tanda Terima Barang</h1>
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable"> 
  ...
  <tr valign="top" bgcolor="#FFFFFF" class="hide">
        ...
        <td><?php if(strstr($_SESSION['akses'],"JS-5-1")) { ?>
          <a href="index.php?component=stt&amp;task=add"><img src="images/add_new.png" border="0" /></a>
        <?php } ?></td>
...
?>
  ...
  <input name="Search" type="submit" id="Search" value="Search" />
	...
	if(isset($_POST['Search'])) {
			...
			echo "<script>window.location=\"index.php?component=stt&mulai=".$_POST[mulai]."&status=".$_POST[status]."&sampai=".$_POST[sampai]."&cr_txt=".str_replace(" ","+",$_POST[cr_txt])."\";</script>";
  ...
  <?php do { ?>
      ...
      <tr valign="top" bgcolor="#FFFFFF">
        ...
        <td align="center" class="hide"><?php if(strstr($_SESSION['akses'],"JS-5-2")) { ?>
          <a href="index.php?component=stt&amp;task=edit&amp;id=<?php echo $row_data['IDSTT']; ?>"><img src="images/edit_.png" alt="edit" border="0" /></a>
          <?php } ?>
          <?php if(strstr($_SESSION['akses'],"JS-5-3")) { ?>
          <a href="index.php?component=stt&amp;task=delete&amp;id=<?php echo $row_data['IDSTT']; ?>" class="ask"><img src="images/delete_.png" border="0" /></a>
          <?php } ?></td>
      </tr>
    ...
    <tr class="hide">
      ...
      <td colspan="16"><table border="0" align="left" width="50%">
