...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable"> 
  <tr valign="top" bgcolor="#FFFFFF" class="hide">
        <td><?php if(strstr($_SESSION['akses'],"PD-5-1")) { ?><a href="index.php?component=unitkerja&amp;task=add"><img src="images/add_new.png" border="0" /></a><?php } ?></td>
  ...
  <?php } ?>
  <tr class="hide">
    <td colspan="4"><a href="index.php?component=unitkerja&amp;task=add"><img src="images/add_new.png" border="0" /></a></td>
  </tr>
</table>