...
$query_data = "SELECT * from v_pricelistagent where IDAGENT = '$_GET[agentid]'";
//printf($query_data);
...
<P align="center" class="style2"><strong>PRICELIST AGENT : <strong><?php echo $row_data['NAMAAGENT']; ?></strong></strong></P>
  ...
  <?php 	
    ...
    <?php $i = 1;do { ?>
        ...
        <tr valign="top">
          ...
          <td align="left"><?php echo $row_data['HANDLING']; ?></td>
          ...
          <td align="left"><?php $t_rate += $row_data['RATEHANDLING'];echo number_format($row_data['RATEHANDLING'],0,',','.').",-"; ?></td>
          <td align="left"><?php echo $row_data['MINPAKET']; ?></td>
        </tr>
        <?php 
		$nomor ++;
			$i++;
