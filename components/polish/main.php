...
$query_data = "SELECT * from ref_dm_polish";
...
<table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" class="datatable"> 
  ...
  <tr>
    ...
    <th width="220"><strong>ALIAS</strong></th>
    <th width="132" align="center" class="hide"><strong>Action</strong></th>
  </tr>
  <?php if($totalRows_data > 0) { ?>
  <?php do { ?>
    <tr valign="top" bgcolor="#FFFFFF">
      <td><?php echo $row_data['polish_code']; ?></td>
      <td><?php echo $row_data['polish_name']; ?></td>
      <td><?php echo $row_data['polish_alias']; ?></td>
      <td align="center" class="hide"><?php if(strstr($_SESSION['akses'],"JS-5-2")) { ?><a href="index.php?component=polish&amp;task=edit&amp;id=<?php echo $row_data['polish_code']; ?>"><img src="images/edit_.png" border="0" /></a><?php } ?> <?php if(strstr($_SESSION['akses'],"JS-5-3")) { ?><!--<a href="index.php?component=merkkendaraan&amp;task=delete&amp;id=<?php echo $row_data['id']; ?>" class="ask"><img src="images/delete_.png" border="0" /></a>--><?php } ?></td>
    </tr>
  ...
  <?php } ?>
  <tr class="hide">
    <td colspan="4"><?php if(strstr($_SESSION[akses],"JS-5-1")) { ?><a href="index.php?component=fluorescence&amp;task=add"><img src="images/add_new.png" border="0" />
    </a><?php } ?></td>
  </tr>
</table>