  ...
  <tr>
    ...
    <td colspan="3" align="left" valign="top"><table width="100%" border="1" cellspacing="0" cellpadding="4">
      ...
      <tr valign="top">
        ...
        <td width="29%"><?php echo $row_detail['nama_dokumen'];?></td>

        <td width="19%"><?php echo $row_detail['dokumen'];?> -<?php echo $row_detail['no_dokumen'];?></td>

        <td width="32%"><?php echo $row_detail['info_dokumen'];?></td>

        <td width="18%" align="right"><span style="background:#EEE;font-weight:bold;text-decoration:underline;">
  ...
  <tr valign="top">
    ...
    <td colspan="3" align="center" valign="top"><table align="left" width="1209" height="130" border="1">
      ...
      <tr>
        ...
        <td height="8" colspan="3"><strong>Says : <i><?php echo ucwords(Terbilang($row_ticketing['nominaljual_dokumen']));?></i>Rupiah</strong></td>
